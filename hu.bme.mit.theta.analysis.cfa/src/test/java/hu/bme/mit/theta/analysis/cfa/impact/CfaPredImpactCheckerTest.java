...
import static hu.bme.mit.theta.core.stmt.impl.Stmts.Assert;
import static hu.bme.mit.theta.core.stmt.impl.Stmts.Assign;
import static hu.bme.mit.theta.core.stmt.impl.Stmts.Block;
import static hu.bme.mit.theta.core.stmt.impl.Stmts.Do;
import static hu.bme.mit.theta.core.stmt.impl.Stmts.If;
...
public final class CfaPredImpactCheckerTest {
	...
	public void test() {
		...
		assertTrue(arg.isSafe());
		assertTrue(arg.isComplete());
