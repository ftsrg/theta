...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D (Array Int Int)) (E Int) (F Int) (G Bool) (H Bool) (I Bool) (J Bool) (K Int) (L Int) (M Int) (N Bool) (O Bool) (P Bool) (Q Bool) (R Bool) (S Bool) (T Int) (U Bool) (V Bool) (W Bool) (X Bool) (Y Bool) ) 
    (=>
      (and
        (main@_bb12 A B C D E L K F)
        (let ((a!1 (or (not R) (not (= (<= L M) O)))))
  (and (not (= (<= K L) H))
       (= J (and H G))
       (or (not R) (not J) (not I))
       (or (not V) (= U (= T 0)))
       (or (not V) (and S V))
       (or (not V) U)
       (or (not W) (and W V))
