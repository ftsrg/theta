...
void step(void) {
 ...
 if (((var_1_2 - 64) + var_1_3) > stepLocal_0) {
  if ((((((var_1_2) < 0 ) ? -(var_1_2) : (var_1_2))) + var_1_3) > stepLocal_1) {
   var_1_1 = var_1_5;
  }
 } else {
  var_1_1 = var_1_5;
...
int property() {
 return (((var_1_2 - 64) + var_1_3) > 0) ? (((((((var_1_2) < 0 ) ? -(var_1_2) : (var_1_2))) + var_1_3) > var_1_4) ? (var_1_1 == ((signed short int) var_1_5)) : 1) : (var_1_1 == ((signed short int) var_1_5))
;
}
int main(void) {
 isInitial = 1;
