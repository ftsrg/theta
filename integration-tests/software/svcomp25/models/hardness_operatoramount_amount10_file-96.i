...
void step(void) {
 var_1_6 = (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) + ((((127.5f) < (var_1_8)) ? (127.5f) : (var_1_8))));
 var_1_9 = var_1_4;
...
int property() {
 return ((((-1000000000 < var_1_9) || var_1_3) ? (var_1_1 == ((unsigned char) (var_1_4 - var_1_5))) : 1) && (var_1_6 == ((float) (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) + ((((127.5f) < (var_1_8)) ? (127.5f) : (var_1_8))))))) && (var_1_9 == ((signed short int) var_1_4))
;
}
int main(void) {
 isInitial = 1;
