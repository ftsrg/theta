...
void step(void) {
 if (last_1_var_1_8 <= 16) {
  ...
  if (((((last_1_var_1_10) > (last_1_var_1_10)) ? (last_1_var_1_10) : (last_1_var_1_10))) < last_1_var_1_10) {
   if (var_1_7) {
    var_1_1 = var_1_3;
   } else {
    var_1_1 = var_1_3;
 ...
 if (((var_1_1 + var_1_9) < 10) || stepLocal_0) {
  var_1_12 = ((((var_1_8) > (var_1_1)) ? (var_1_8) : (var_1_1)));
 } else {
  var_1_12 = var_1_8;
 }
}
