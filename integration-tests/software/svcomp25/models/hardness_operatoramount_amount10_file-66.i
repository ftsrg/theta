...
int property() {
 return (((last_1_var_1_1 <= (var_1_3 - var_1_4)) ? (var_1_1 == ((unsigned char) (var_1_5 - var_1_6))) : (var_1_1 == ((unsigned char) (((((var_1_5) > (128)) ? (var_1_5) : (128))) - var_1_6)))) && (var_1_7 == ((unsigned char) var_1_8))) && (var_1_9 == ((signed char) var_1_10))
;
}
int main(void) {
 isInitial = 1;
