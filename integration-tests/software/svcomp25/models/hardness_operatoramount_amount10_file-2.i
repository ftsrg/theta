...
void step(void) {
 ...
 if ((var_1_2 - ((((var_1_3) < (last_1_var_1_1)) ? (var_1_3) : (last_1_var_1_1)))) < stepLocal_0) {
  var_1_1 = (((((var_1_6) > (var_1_7)) ? (var_1_6) : (var_1_7))) + (var_1_8 + (2 + 4)));
 }
}
...
int property() {
 return (((var_1_2 - ((((var_1_3) < (last_1_var_1_1)) ? (var_1_3) : (last_1_var_1_1)))) < var_1_9) ? (var_1_1 == ((unsigned char) (((((var_1_6) > (var_1_7)) ? (var_1_6) : (var_1_7))) + (var_1_8 + (2 + 4))))) : 1) && (var_1_9 == ((unsigned long int) var_1_6))
;
}
int main(void) {
 isInitial = 1;
