...
int property() {
 return (((-50 < var_1_6) || var_1_3) ? (var_1_1 == ((unsigned short int) ((((((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))) < (var_1_5)) ? (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))) : (var_1_5))))) : 1) && (var_1_6 == ((signed char) (((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8))) - (var_1_9 - 25))))
;
}
int main(void) {
 isInitial = 1;
