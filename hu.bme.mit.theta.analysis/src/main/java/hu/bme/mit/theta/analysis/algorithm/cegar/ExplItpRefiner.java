...
public final class ExplItpRefiner<S extends ExprState, A extends ExprAction> implements Refiner<S, A, ExplPrecision> {
	...
	public static <S extends ExprState, A extends ExprAction> ExplItpRefiner<S, A> create(
