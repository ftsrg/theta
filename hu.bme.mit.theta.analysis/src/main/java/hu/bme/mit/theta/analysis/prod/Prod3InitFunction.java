...
final class Prod3InitFunction<S1 extends State, S2 extends State, S3 extends State, P1 extends Precision, P2 extends Precision, P3 extends Precision>
		implements InitFunction<Prod3State<S1, S2, S3>, Prod3Precision<P1, P2, P3>> {
	...
	public static <S1 extends State, S2 extends State, S3 extends State, P1 extends Precision, P2 extends Precision, P3 extends Precision> Prod3InitFunction<S1, S2, S3, P1, P2, P3> create(
	...
	@Override
	public Collection<? extends Prod3State<S1, S2, S3>> getInitStates(final Prod3Precision<P1, P2, P3> precision) {
