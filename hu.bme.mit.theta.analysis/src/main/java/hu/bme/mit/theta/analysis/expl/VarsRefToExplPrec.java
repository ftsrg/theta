...
public class VarsRefToExplPrec implements RefutationToPrec<ExplPrec, IndexedVarsRefutation> {

	@Override
	public ExplPrec toPrec(final IndexedVarsRefutation refutation, final int index) {
