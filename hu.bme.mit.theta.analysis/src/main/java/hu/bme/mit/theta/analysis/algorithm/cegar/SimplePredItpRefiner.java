...
public final class SimplePredItpRefiner<S extends ExprState, A extends ExprAction>
	...
	public static <S extends ExprState, A extends ExprAction> SimplePredItpRefiner<S, A> create(
