...
import hu.bme.mit.theta.common.visualization.GraphVizPrinter;
...
public class TcfaDslTest {
	...
	public void testFischer() throws FileNotFoundException, IOException {
		...
		System.out.println("==================");
		System.out.println(new GraphVizPrinter().print(TcfaVisualizer.visualize(fischer)));
	}
	...
	public void testProsigma() throws FileNotFoundException, IOException {
		...
		System.out.println("==================");
		System.out.println(new GraphVizPrinter().print(TcfaVisualizer.visualize(field)));
	}
