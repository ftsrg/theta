...
void step(void) {
	...
	// From: Req7Batch144dependencies
	if (var_1_17 && var_1_26) {
		var_1_23 = (var_1_24 - var_1_25);
	}


	// From: Req9Batch144dependencies
