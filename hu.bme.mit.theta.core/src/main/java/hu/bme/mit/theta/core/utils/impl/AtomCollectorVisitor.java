...
public class AtomCollectorVisitor implements ExprVisitor<Collection<Expr<BoolType>>, Void> {

	protected Void visitNonBoolConnective(final Expr<?> expr, final Collection<Expr<BoolType>> param) {
		param.add(TypeUtils.cast(expr, BoolType.class));
		return null;
	}

	@Override
	public <DeclType extends Type> Void visit(final RefExpr<DeclType> expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public <ExprType extends Type> Void visit(final PrimedExpr<ExprType> expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final FalseExpr expr, final Collection<Expr<BoolType>> param) {
		param.add(expr);
		return null;
	}

	@Override
	public Void visit(final TrueExpr expr, final Collection<Expr<BoolType>> param) {
		param.add(expr);
		return null;
	}

	@Override
	public Void visit(final NotExpr expr, final Collection<Expr<BoolType>> param) {
		expr.getOp().accept(this, param);
		return null;
	}

	@Override
	public Void visit(final ImplyExpr expr, final Collection<Expr<BoolType>> param) {
	...
	@Override
	public Void visit(final IffExpr expr, final Collection<Expr<BoolType>> param) {
		expr.getLeftOp().accept(this, param);
		expr.getRightOp().accept(this, param);
		return null;
	}
	...
	@Override
	public Void visit(final AndExpr expr, final Collection<Expr<BoolType>> param) {
		expr.getOps().forEach(op -> op.accept(this, param));
		return null;
	}

	@Override
	public Void visit(final OrExpr expr, final Collection<Expr<BoolType>> param) {
		expr.getOps().forEach(op -> op.accept(this, param));
		return null;
	}

	@Override
	public Void visit(final ExistsExpr expr, final Collection<Expr<BoolType>> param) {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("TODO");
	}

	@Override
	public Void visit(final ForallExpr expr, final Collection<Expr<BoolType>> param) {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("TODO");
	}

	@Override
	public Void visit(final EqExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final NeqExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final GeqExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final GtExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final LeqExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final LtExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final IntLitExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final IntDivExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final RemExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final ModExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final RatLitExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}

	@Override
	public Void visit(final RatDivExpr expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}
	...
	@Override
	public <ExprType extends Type> Void visit(final IteExpr<ExprType> expr, final Collection<Expr<BoolType>> param) {
		return visitNonBoolConnective(expr, param);
	}
