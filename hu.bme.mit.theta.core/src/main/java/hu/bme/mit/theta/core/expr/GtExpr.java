...
public final class GtExpr extends BinaryExpr<RatType, RatType, BoolType> {

	private static final int HASH_SEED = 863;

	private static final String OPERATOR_LABEL = "Gt";

	public GtExpr(final Expr<? extends RatType> leftOp, final Expr<? extends RatType> rightOp) {
