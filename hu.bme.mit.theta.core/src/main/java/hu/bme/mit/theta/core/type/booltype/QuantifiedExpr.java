...
public abstract class QuantifiedExpr implements Expr<BoolType> {
	...
	protected QuantifiedExpr(final Collection<? extends ParamDecl<? extends Type>> paramDecls,
	...
	public abstract QuantifiedExpr withOp(final Expr<? extends BoolType> op);
