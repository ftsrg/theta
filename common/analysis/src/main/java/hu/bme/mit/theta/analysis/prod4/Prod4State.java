...
public abstract class Prod4State<S1 extends State, S2 extends State, S3 extends State, S4 extends State>
	...
	private static final class Product<S1 extends State, S2 extends State, S3 extends State, S4 extends State>
		...
		public Expr<BoolType> toExpr() {
			if (state1 instanceof ExprState && state2 instanceof ExprState && state3 instanceof ExprState) {
				...
				return And(exprState1.toExpr(), exprState2.toExpr(), exprState3.toExpr(), exprState4.toExpr());
			} else {
		...
		public String toString() {
			return Utils.lispStringBuilder(Prod4State.class.getSimpleName()).body().add(state1).add(state2).add(state3)
					.add(state4).toString();
		}
	}
	...
	private static abstract class Bottom<S1 extends State, S2 extends State, S3 extends State, S4 extends State>
		...
		public final String toString() {
			return Utils.lispStringBuilder(Prod4State.class.getSimpleName()).add(getIndex()).add(getState()).toString();
		}
	}
