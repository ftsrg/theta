...
public final class XtaLocLts implements LTS<XtaLocState<?>, XtaAction> {

	private final XtaSystem system;

	private XtaLocLts(final XtaSystem system) {
		this.system = checkNotNull(system);
	}

	public static XtaLocLts create(final XtaSystem system) {
		return new XtaLocLts(system);
	}

	@Override
	public Collection<XtaAction> getEnabledActionsFor(final XtaLocState<?> state) {
	...
	private static void addActionsForEdge(final Collection<XtaAction> result, final XtaSystem system,
			final XtaLocState<?> state, final Edge edge) {
	...
	private static void addSyncActionsForEdge(final Collection<XtaAction> result, final XtaSystem system,
			final XtaLocState<?> state, final Edge emitEdge) {
