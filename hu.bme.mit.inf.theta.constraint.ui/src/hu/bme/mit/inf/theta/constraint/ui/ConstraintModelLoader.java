...
import hu.bme.mit.inf.theta.constraint.language.ConstraintLanguageStandaloneSetup;
import hu.bme.mit.inf.theta.constraint.model.ConstraintModelPackage;
...
public class ConstraintModelLoader {
	...
	public ConstraintSpecification load(final String filePath) {
	...
	public void save(final ConstraintSpecification specification, final String fileName) throws IOException {
