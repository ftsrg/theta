...
import hu.bme.mit.inf.theta.program.language.ProgramLanguageStandaloneSetup;
import hu.bme.mit.inf.theta.program.model.ProgramModelPackage;
...
public class ProgramModelLoader {
	...
	public ProgramSpecification load(final String filePath) {
	...
	public void save(final ProgramSpecification specification, final String fileName) throws IOException {
