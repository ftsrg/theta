...
class OutputOptions : OptionGroup(
    name = "Output options",
    help = "Options related to output and statistics"
) {

    val logLevel: Logger.Level by option(help = "Detailedness of logging").enum<Logger.Level>()
        .default(Logger.Level.SUBSTEP)
    val benchmarkMode: Boolean by option(
        "--benchmark", help = "Quiet mode, output will be just the result metrics"
