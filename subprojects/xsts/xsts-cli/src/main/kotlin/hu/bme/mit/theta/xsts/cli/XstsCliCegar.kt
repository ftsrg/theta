...
class XstsCliCegar : XstsCliBaseCommand(
    ...
    private val refinement: Refinement by option(help = "Refinement strategy to use").enum<Refinement>()
        .default(Refinement.SEQ_ITP)
    private val search: Search by option(help = "Search strategy to use").enum<Search>().default(Search.BFS)
