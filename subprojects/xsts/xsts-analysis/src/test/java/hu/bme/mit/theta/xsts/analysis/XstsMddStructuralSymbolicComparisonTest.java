...
public class XstsMddStructuralSymbolicComparisonTest {
    ...
    public void test() throws Exception {
        ...
        //                                domainSize));
        //                transOrder.createOnTop(MddVariableDescriptor.create(v.getConstDecl(0),
        // domainSize));
        //
        //                structOrder.createOnTop(
        //                        MddVariableDescriptor.create(v.getName() + "2", domainSize));
        //                structOrder.createOnTop(MddVariableDescriptor.create(v.getName(),
        // domainSize));
        //
        ...
        //                            .checkInNode(MddExpressionTemplate.of(stmtUnfold, o -> (Decl)
        // o, pool));
        //
