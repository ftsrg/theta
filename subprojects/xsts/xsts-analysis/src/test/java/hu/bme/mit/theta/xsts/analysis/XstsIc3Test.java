    ...
    public void test() throws Exception {
        ...
        try {
            ...
            var checker = new ConnectedIc3Checker<>(
                    ...
                    valuation -> XstsToMonolithicExprKt.valToState(xsts, valuation),
                    (Valuation v1, Valuation v2) -> XstsToMonolithicExprKt.valToAction(xsts, v1, v2));
            Assert.assertEquals(safe, checker.check(null).isSafe());
