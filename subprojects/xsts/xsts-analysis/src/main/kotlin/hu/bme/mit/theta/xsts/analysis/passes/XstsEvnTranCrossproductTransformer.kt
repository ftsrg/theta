...
object XstsEvnTranCrossproductTransformer {
    ...
    fun transform(xsts: XSTS): XSTS {
        ...
        */
        ...
        val envOrig = if (xsts.env.stmts.size == 1 && xsts.env.stmts.get(0) is NonDetStmt) xsts.env.stmts[0] as NonDetStmt else xsts.env
        val tranOrig = if (xsts.tran.stmts.size == 1 && xsts.tran.stmts.get(0) is NonDetStmt) xsts.tran.stmts[0] as NonDetStmt else xsts.tran
