...
public class JavaSMTSolverArrayTest {
    ...
    public void testOperationEquals(Class<?> exprType, Expr<?> expected, Expr<?> actual) {
        initJavaSMTSolverArrayTest(exprType, expected, actual);
        // Sanity check
    ...
    public void initJavaSMTSolverArrayTest(Class<?> exprType, Expr<?> expected, Expr<?> actual) {
