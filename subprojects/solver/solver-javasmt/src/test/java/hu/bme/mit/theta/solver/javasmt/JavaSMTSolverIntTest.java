...
public class JavaSMTSolverIntTest {
    ...
    public void testOperationEquals(Class<?> exprType, Expr<?> expected, Expr<?> actual) {
        initJavaSMTSolverIntTest(exprType, expected, actual);
        // Sanity check
    ...
    public void initJavaSMTSolverIntTest(Class<?> exprType, Expr<?> expected, Expr<?> actual) {
