...
class GraphSolverTest<T> {
  ...
  companion object {
    ...
    private val smallLine: Pair<List<Int>, Map<Pair<String, Tuple>, ThreeVL>> =
      Pair(
        listOf(1, 2, 3),
        mapOf(
    ...
    private val smallCycle: Pair<List<Int>, Map<Pair<String, Tuple>, ThreeVL>> =
      Pair(
        listOf(1, 2, 3),
        mapOf(
          Pair(Pair("po", Tuple2.of(1, 1)), ThreeVL.FALSE),
    ...
    private val smallFull: Pair<List<Int>, Map<Pair<String, Tuple>, ThreeVL>> =
      Pair(
        listOf(1, 2, 3),
        mapOf(
    ...
    fun data(): Collection<Array<Any>> {
      return Arrays.asList(
        ...
        arrayOf(
          Empty(
            Difference(Sequence(BasicRelation("po"), BasicRelation("po")), BasicRelation("po"))
          ),
          Pattern2ExprCompiler(),
          smallFull.first,
          smallFull.second,
