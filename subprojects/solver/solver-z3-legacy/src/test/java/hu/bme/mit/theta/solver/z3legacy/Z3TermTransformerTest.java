...
public class Z3TermTransformerTest {
    ...
    public void testIntToBvRoundtrip() {
        try (final var context = new Context()) {
            ...
            final var typeSymbolTable = new Z3TypeSymbolTable();
            final var transformationManager =
                    new Z3TransformationManager(symbolTable, typeSymbolTable, context);
            final var termTransformer = new Z3TermTransformer(symbolTable, typeSymbolTable);
