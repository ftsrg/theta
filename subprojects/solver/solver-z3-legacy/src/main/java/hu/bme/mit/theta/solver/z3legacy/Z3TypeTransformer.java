...
final class Z3TypeTransformer {
    ...
    public com.microsoft.z3legacy.Sort toSort(final Type type) {
        if (type instanceof BoolType) {
            ...
            final Optional<com.microsoft.z3legacy.BitVecSort> bvSort =
                    bvSorts.stream().filter(sort -> sort.getSize() == bvType.getSize()).findAny();
            if (bvSort.isPresent()) {
                return bvSort.get();
            } else {
                final com.microsoft.z3legacy.BitVecSort newBvSort =
            ...
            final Optional<com.microsoft.z3legacy.FPSort> fpSort =
                    fpSorts.stream()
                            .filter(
                                    sort ->
            ...
            if (fpSort.isPresent()) {
                ...
                final com.microsoft.z3legacy.FPSort newFpSort =
