...
public class GenericSmtLibTermTransformer implements SmtLibTermTransformer {
    ...
    public GenericSmtLibTermTransformer(final SmtLibSymbolTable symbolTable) {
        this(symbolTable, EnumStrategy.getDefaultStrategy());
    }

    public GenericSmtLibTermTransformer(final SmtLibSymbolTable symbolTable, final EnumStrategy enumStrategy) {
