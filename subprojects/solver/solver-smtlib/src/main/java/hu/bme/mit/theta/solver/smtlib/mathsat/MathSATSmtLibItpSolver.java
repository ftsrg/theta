...
import hu.bme.mit.theta.solver.smtlib.BaseSmtLibItpSolver;
import hu.bme.mit.theta.solver.smtlib.SmtLibInterpolant;
import hu.bme.mit.theta.solver.smtlib.SmtLibModel;
import hu.bme.mit.theta.solver.smtlib.SmtLibSolverBinary;
...
public class MathSATSmtLibItpSolver extends BaseSmtLibItpSolver<MathSATSmtLibItpMarker> {
    ...
    public ItpPattern createTreePattern(final ItpMarkerTree<? extends ItpMarker> root) {
        checkNotNull(root);
        return MathSATSmtLibItpPattern.of(root);
    }
    ...
    public Interpolant getInterpolant(final ItpPattern pattern) {
        ...
        checkArgument(pattern instanceof MathSATSmtLibItpPattern);
        final var mathsatItpPattern = (MathSATSmtLibItpPattern) pattern;
