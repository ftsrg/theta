...
public class SMTInterpolSmtLibSolverFactory implements SolverFactory {
    ...
    private SMTInterpolSmtLibSolverFactory(Path solverPath, String[] args, final EnumStrategy enumStrategy) {
        this.solverPath = solverPath;
        this.args = args;
        this.enumStrategy = enumStrategy;
    }

    public static SMTInterpolSmtLibSolverFactory create(Path solverPath, String[] args, final EnumStrategy enumStrategy) {
