...
public enum SmtLibEnumStrategy {
    ...
    DATATYPES {
        @Override
        public void declareDatatypes(final Collection<? extends Type> allTypes, final Stack<EnumType> typeStack, final Consumer<String> issueGeneralCommand) {
    ...
    SORTS {
        @Override
        public void declareDatatypes(Collection<? extends Type> allTypes, Stack<EnumType> typeStack, Consumer<String> issueGeneralCommand) {
            List<Type> types = new ArrayList<>(allTypes);
            types.removeAll(typeStack.toCollection());
            Set<Type> typeSet = new HashSet<>(types);
            for (Type t :
    ...
    public abstract void declareDatatypes(final Collection<? extends Type> allTypes, final Stack<EnumType> typeStack, final Consumer<String> issueGeneralCommand);
