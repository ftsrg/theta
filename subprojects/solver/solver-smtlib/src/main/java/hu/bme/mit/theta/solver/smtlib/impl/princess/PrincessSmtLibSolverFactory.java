...
public class PrincessSmtLibSolverFactory extends GenericSmtLibSolverFactory {
    ...
    private PrincessSmtLibSolverFactory(Path solverPath, String[] args, final EnumStrategy enumStrategy) {
        super(solverPath, args, EnumSet.of(GenericSmtLibSolverBinary.Solver.PRINCESS), enumStrategy);
    }

    public static PrincessSmtLibSolverFactory create(Path solverPath, String[] args, final EnumStrategy enumStrategy) {
