...
public class MathSATSmtLibSolverInstaller extends SmtLibSolverInstaller.Default {
    ...
    public MathSATSmtLibSolverInstaller() {
        ...
        versions.add(
                SemVer.VersionDecoder.create(SemVer.of("5.6.7"))
                        ...
                        .build());
        versions.add(
                SemVer.VersionDecoder.create(SemVer.of("5.5.0"))
                        .addString(LINUX, X64, "linux-x86_64")
                        .addString(MAC, X64, "darwin-libcxx-x86_64")
                        .addString(WINDOWS, X64, "win64-msvc")
                        .build());
        versions.add(
                SemVer.VersionDecoder.create(SemVer.of("5.3.6"))
                        .addString(LINUX, X64, "linux-x86_64")
                        ...
                        .build());
        versions.add(
                SemVer.VersionDecoder.create(SemVer.of("5.2.12"))
                        .addString(LINUX, X64, "linux-x86_64")
                        .addString(LINUX, X86, "linux-x86")
                        .addString(MAC, X64, "darwin-libcxx-x86_64")
                        ...
                        .build());
        versions.add(
                SemVer.VersionDecoder.create(SemVer.of("5.2.9"))
                        .addString(LINUX, X64, "linux-x86_64")
                        .addString(LINUX, X86, "linux-x86")
                        .addString(MAC, X64, "darwin-libcxx-x86_64")
                        .addString(WINDOWS, X64, "win64-msvc")
                        ...
                        .build());
        versions.add(
                SemVer.VersionDecoder.create(SemVer.of("5.2.6"))
                        .addString(LINUX, X64, "linux-x86_64")
                        .addString(LINUX, X86, "linux-x86")
                        ...
                        .build());
        versions.add(
                SemVer.VersionDecoder.create(SemVer.of("5.1.10"))
                        .addString(LINUX, X64, "linux-x86_64")
                        .addString(LINUX, X86, "linux-x86")
                        .addString(MAC, X64, "darwin-x86_64")
                        .build());
        versions.add(
                SemVer.VersionDecoder.create(SemVer.of("5.1.1"))
                        .addString(LINUX, X64, "linux-x86_64")
                        .addString(LINUX, X86, "linux-x86")
                        .build());
    }
    ...
    public List<String> getSupportedVersions() {
        return Arrays.asList(
                "5.6.12", "5.6.11", "5.6.10", "5.6.9", "5.6.8", "5.6.7", "5.6.6", "5.6.5", "5.6.4",
                "5.6.3", "5.6.2", "5.6.1", "5.6.0", "5.5.4", "5.5.3", "5.5.2", "5.5.1", "5.5.0",
                "5.4.1", "5.4.0", "5.3.14", "5.3.13", "5.3.12", "5.3.11", "5.3.10", "5.3.9",
                "5.3.8", "5.3.7", "5.3.6", "5.3.5", "5.3.4", "5.3.3", "5.3.2", "5.3.1", "5.2.12",
                "5.2.11", "5.2.10", "5.2.9", "5.2.8", "5.2.7", "5.2.6", "5.2.5", "5.2.4", "5.2.3",
                "5.2.2", "5.2.1", "5.1.12", "5.1.11", "5.1.10", "5.1.9", "5.1.8", "5.1.7", "5.1.6",
                "5.1.5", "5.1.4", "5.1.3");
    }
