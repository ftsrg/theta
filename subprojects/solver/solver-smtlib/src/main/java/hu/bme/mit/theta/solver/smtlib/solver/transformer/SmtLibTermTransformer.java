...
public interface SmtLibTermTransformer {
    ...
    <P extends Type, R extends Type> LitExpr<FuncType<P, R>> toFuncLitExpr(
            String funcLitImpl, FuncType<P, R> type, SmtLibModel model);
    ...
    <I extends Type, E extends Type> LitExpr<ArrayType<I, E>> toArrayLitExpr(
            String arrayLitImpl, ArrayType<I, E> type, SmtLibModel model);
