...
public class PrincessSmtLibSolverInstaller extends SmtLibSolverInstaller.Default {
    ...
    protected void installSolver(final Path installDir, final String version)
        ...
        final var downloadUrl =
                Integer.parseInt(version.substring(0, 4)) > 2021
                        ? URI.create(
                                String.format(
    ...
    protected String[] getDefaultSolverArgs(String version) {
        return new String[] {"+stdin", "+incremental", "+quiet"};
    }
    ...
    public SolverFactory getSolverFactory(
        ...
        return PrincessSmtLibSolverFactory.create(
                solverFilePath, solverArgs, SmtLibEnumStrategy.SORTS);
    }
