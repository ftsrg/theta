...
public class GetModelResponse extends SpecificResponse {
    ...
    public static GetModelResponse fromContext(final Get_model_responseContext ctx) {
        return new GetModelResponse(
                ctx.model_response().stream()
                        .map(
                                member ->
                                        member.accept(
                                                new SMTLIBv2BaseVisitor<Tuple2<String, String>>() {
                                                    @Override
                                                    public Tuple2<String, String>
                                                            visitModel_response_fun(
                                                    ...
                                                    @Override
                                                    public Tuple2<String, String>
                                                            visitModel_response_mathsat(
                                                                    Model_response_mathsatContext
                                                                            ctx) {
                                                        final var functionDef =
                                                                String.format(
                                                                        "%s () (_ theta_type"
                                                                                + " unknown) %s",
                                                    ...
                                                    @Override
                                                    public Tuple2<String, String>
                                                            visitModel_response_fun_rec(
                                                                    Model_response_fun_recContext
                                                                            ctx) {
                                                    ...
                                                    @Override
                                                    public Tuple2<String, String>
                                                            visitModel_response_funs_rec(
                                                                    Model_response_funs_recContext
                                                                            ctx) {
                                                        throw new UnsupportedOperationException();
                                                    }
                                                }))
