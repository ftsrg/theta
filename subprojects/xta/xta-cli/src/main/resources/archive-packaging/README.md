...
For more parameters, check out [the documentation on CEGAR](https://github.com/ftsrg/theta/blob/master/doc/CEGAR-algorithms.md) *(might not be up to date on every parameter, but gives a detailed explanation on them)* and [the main class of the XTA project](https://github.com/ftsrg/theta/blob/master/subprojects/xta/xta-cli/src/main/java/hu/bme/mit/theta/xta/cli/XtaCli.java).
