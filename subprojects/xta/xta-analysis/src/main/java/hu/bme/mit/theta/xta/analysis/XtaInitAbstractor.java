...
public final class XtaInitAbstractor<SConcr extends State, SAbstr extends State>
        implements InitAbstractor<XtaState<SConcr>, XtaState<SAbstr>> {
    ...
    public static <SConcr extends State, SAbstr extends State>
            XtaInitAbstractor<SConcr, SAbstr> create(
