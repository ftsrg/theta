...
public final class LazyXtaAbstractor<SConcr extends State, SAbstr extends State, P extends Prec>
        implements ArgAbstractor<LazyState<XtaState<SConcr>, XtaState<SAbstr>>, XtaAction, UnitPrec> {
    ...
    @Override
    public ARG<LazyState<XtaState<SConcr>, XtaState<SAbstr>>, XtaAction> createProof() {
