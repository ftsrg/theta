...
public final class XtaZoneInvTransFunc implements InvTransFunc<ZoneState, XtaAction, ZonePrec> {
    ...
    private static final XtaZoneInvTransFunc INSTANCE = new XtaZoneInvTransFunc();
    ...
    @Override
    public Collection<? extends ZoneState> getPreStates(
            ZoneState state, XtaAction action, ZonePrec prec) {
