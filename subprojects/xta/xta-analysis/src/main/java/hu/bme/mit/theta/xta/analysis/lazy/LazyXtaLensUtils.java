...
public final class LazyXtaLensUtils {
    ...
    public static <DConcr extends State, DAbstr extends ExprState>
            Lens<
                            LazyState<
                                    XtaState<Prod2State<DConcr, ?>>,
                                    XtaState<Prod2State<DAbstr, ?>>>,
                            LazyState<DConcr, DAbstr>>
                    createLazyDataLens() {
        final Lens<
                        LazyState<XtaState<Prod2State<DConcr, ?>>, XtaState<Prod2State<DAbstr, ?>>>,
                        DConcr>
                concrLens = createConcrDataLens();
        final Lens<
                        LazyState<XtaState<Prod2State<DConcr, ?>>, XtaState<Prod2State<DAbstr, ?>>>,
                        DAbstr>
                abstrLens = createAbstrDataLens();
        return new Lens<>() {
            @Override
            public LazyState<DConcr, DAbstr> get(
                    LazyState<XtaState<Prod2State<DConcr, ?>>, XtaState<Prod2State<DAbstr, ?>>>
                            state) {
            ...
            public LazyState<XtaState<Prod2State<DConcr, ?>>, XtaState<Prod2State<DAbstr, ?>>> set(
                ...
                final XtaState<Prod2State<DConcr, ?>> newConcrState =
                        concrLens.set(lazyState, newItpDataState.getConcrState()).getConcrState();
                final XtaState<Prod2State<DAbstr, ?>> newAbstrState =
                        abstrLens.set(lazyState, newItpDataState.getAbstrState()).getAbstrState();
                return LazyState.of(newConcrState, newAbstrState);
            }
        };
    }

    public static <CConcr extends State, CAbstr extends ExprState>
            Lens<
                            LazyState<
                                    XtaState<Prod2State<?, CConcr>>,
                                    XtaState<Prod2State<?, CAbstr>>>,
                            LazyState<CConcr, CAbstr>>
                    createLazyClockLens() {
        final Lens<
                        LazyState<XtaState<Prod2State<?, CConcr>>, XtaState<Prod2State<?, CAbstr>>>,
                        CConcr>
                concrLens = createConcrClockLens();
        final Lens<
                        LazyState<XtaState<Prod2State<?, CConcr>>, XtaState<Prod2State<?, CAbstr>>>,
                        CAbstr>
                abstrLens = createAbstrClockLens();
        return new Lens<>() {
            @Override
            public LazyState<CConcr, CAbstr> get(
                    LazyState<XtaState<Prod2State<?, CConcr>>, XtaState<Prod2State<?, CAbstr>>>
                            state) {
            ...
            public LazyState<XtaState<Prod2State<?, CConcr>>, XtaState<Prod2State<?, CAbstr>>> set(
                ...
                final XtaState<Prod2State<?, CConcr>> newConcrState =
                        concrLens.set(lazyState, newItpDataState.getConcrState()).getConcrState();
                final XtaState<Prod2State<?, CAbstr>> newAbstrState =
                        abstrLens.set(lazyState, newItpDataState.getAbstrState()).getAbstrState();
                return LazyState.of(newConcrState, newAbstrState);
            }
        };
    ...
    public static <DConcr extends State, DAbstr extends State>
            Lens<
                            LazyState<
                                    XtaState<Prod2State<DConcr, ?>>,
                                    XtaState<Prod2State<DAbstr, ?>>>,
        ...
        return new Lens<>() {
            ...
            public LazyState<XtaState<Prod2State<DConcr, ?>>, XtaState<Prod2State<DAbstr, ?>>> set(
                ...
                final XtaState<Prod2State<DConcr, ?>> newConcrXtaState =
                        concrXtaState.withState(newConcrState);
    ...
    public static <DConcr extends State, DAbstr extends State>
        ...
        return new Lens<>() {
            ...
            public LazyState<XtaState<Prod2State<DConcr, ?>>, XtaState<Prod2State<DAbstr, ?>>> set(
                ...
                final XtaState<Prod2State<DAbstr, ?>> newAbstrXtaState =
                        abstrXtaState.withState(newAbstrState);
                return lazyState.withAbstrState(newAbstrXtaState);
            }
        };
    }

    public static <CConcr extends State, CAbstr extends State>
            Lens<
                            LazyState<
                                    XtaState<Prod2State<?, CConcr>>,
                                    XtaState<Prod2State<?, CAbstr>>>,
        ...
        return new Lens<>() {
            ...
            public LazyState<XtaState<Prod2State<?, CConcr>>, XtaState<Prod2State<?, CAbstr>>> set(
                ...
                final XtaState<Prod2State<?, CConcr>> newConcrXtaState =
                        concrXtaState.withState(newConcrState);
                return lazyState.withConcrState(newConcrXtaState);
            }
        };
    ...
    public static <CConcr extends State, CAbstr extends State>
        ...
        return new Lens<>() {
            ...
            public LazyState<XtaState<Prod2State<?, CConcr>>, XtaState<Prod2State<?, CAbstr>>> set(
                ...
                final XtaState<Prod2State<?, CAbstr>> newAbstrXtaState =
                        abstrXtaState.withState(newAbstrState);
                return lazyState.withAbstrState(newAbstrXtaState);
            }
        };
    ...
    public static <
                    ...
                    DAbstr extends State,
                    CAbstr extends State>
            Lens<
                            LazyState<
                                    XtaState<Prod2State<DConcr, CConcr>>,
                                    XtaState<Prod2State<DAbstr, CAbstr>>>,
                            Prod2State<DConcr, CConcr>>
                    createConcrProd2Lens() {
        return new Lens<>() {
            @Override
            public Prod2State<DConcr, CConcr> get(
                    LazyState<
                                    XtaState<Prod2State<DConcr, CConcr>>,
                                    XtaState<Prod2State<DAbstr, CAbstr>>>
                            state) {
            ...
            public LazyState<
                ...
                final XtaState<Prod2State<DConcr, CConcr>> concrXtaState =
                        lazyState.getConcrState();
                final XtaState<Prod2State<DConcr, CConcr>> newXtaState =
                        concrXtaState.withState(newConcrState);
