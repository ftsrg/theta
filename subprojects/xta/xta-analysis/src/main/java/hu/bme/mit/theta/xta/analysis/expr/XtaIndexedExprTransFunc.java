...
public final class XtaIndexedExprTransFunc
        implements TransFunc<IndexedExprState, XtaAction, UnitPrec> {

    private static final XtaIndexedExprTransFunc INSTANCE = new XtaIndexedExprTransFunc();
    ...
    public Collection<? extends IndexedExprState> getSuccStates(
            IndexedExprState state, XtaAction action, UnitPrec prec) {
