...
public final class XtaZoneAnalysisTest {
    ...
    public void test() throws FileNotFoundException, IOException {
        ...
        final Abstractor<XtaState<Prod2State<ExplState, ZoneState>>, XtaAction, ZonePrec>
                abstractor =
                        BasicAbstractor.builder(argBuilder).projection(s -> s.getLocs()).build();

        final ARG<XtaState<Prod2State<ExplState, ZoneState>>, XtaAction> arg =
                abstractor.createArg();
