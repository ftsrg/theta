...
public final class XtaVisualizer {
    ...
    private static void traverseProcess(
            final XtaProcess process, final Graph graph, final Map<Object, String> ids) {
    ...
    private static void addProcess(
        ...
        final NodeAttributes nAttrs =
                NodeAttributes.builder()
                        ...
                        .peripheries(LOC_PERIPHERIES)
                        .build();
        graph.addCompositeNode(id, nAttrs);
    }

    private static void addPhantomInit(
            final XtaProcess process, final Graph graph, final Map<Object, String> ids) {
    ...
    private static void addEdge(
            final Graph graph, final Map<Object, String> ids, final Edge outEdge) {
