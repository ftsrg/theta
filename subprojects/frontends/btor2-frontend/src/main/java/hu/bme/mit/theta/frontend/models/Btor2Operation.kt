...
data class Btor2BinaryOperation(override val nid: UInt, override val sort : Btor2Sort, val operator: Btor2BinaryOperator, val op1: Btor2Node, val op2: Btor2Node, val opd1_negated: Boolean, val opd2_negated: Boolean) : Btor2Operation(nid, sort)
{
    ...
    override fun getExpr(): Expr<BvType> {
        ...
        return when(operator)
        {
            Btor2BinaryOperator.ADD -> BvAddExpr.create(mutableListOf(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>))
            ...
            Btor2BinaryOperator.MUL -> BvMulExpr.create(mutableListOf(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>))
            Btor2BinaryOperator.SUB -> BvSubExpr.create(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>)
            Btor2BinaryOperator.UDIV -> BvUDivExpr.create(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>)
            Btor2BinaryOperator.UREM -> BvURemExpr.create(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>)
            Btor2BinaryOperator.SDIV -> BvSDivExpr.create(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>)
            Btor2BinaryOperator.SREM -> BvSRemExpr.create(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>)
            Btor2BinaryOperator.SMOD -> BvSModExpr.create(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>)
            Btor2BinaryOperator.CONCAT -> BvConcatExpr.create(mutableListOf(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>))
            ...
            Btor2BinaryOperator.ROL -> BvRotateLeftExpr.create(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>)
            Btor2BinaryOperator.ROR -> BvRotateRightExpr.create(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>)
            Btor2BinaryOperator.SLL -> BvShiftLeftExpr.create(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>)
            Btor2BinaryOperator.SRA -> BvArithShiftRightExpr.of(op1ExprLogical as Expr<BvType>, op2ExprLogical as Expr<BvType>)
