...
data class Btor2BinaryOperation(override val nid: UInt, override val sort : Btor2Sort, val operator: Btor2BinaryOperator, val op1: Btor2Node, val op2: Btor2Node, val opd1_negated: Boolean, val opd2_negated: Boolean) : Btor2Operation(nid, sort)
{
    ...
    override fun getExpr(): Expr<BvType> {
        ...
        return when(operator)
        {
            ...
            Btor2BinaryOperator.AND -> BvAndExpr.create(mutableListOf(op1ExprArithmetic as Expr<BvType>, op2ExprArithmetic as Expr<BvType>))
            Btor2BinaryOperator.NAND -> BvNotExpr.create(BvAndExpr.create(mutableListOf(op1ExprArithmetic as Expr<BvType>, op2ExprArithmetic as Expr<BvType>)))
            Btor2BinaryOperator.NOR -> BvNotExpr.create(BvOrExpr.create(mutableListOf(op1ExprArithmetic as Expr<BvType>, op2ExprArithmetic as Expr<BvType>)))
            Btor2BinaryOperator.OR -> BvOrExpr.create(mutableListOf(op1ExprArithmetic as Expr<BvType>, op2ExprArithmetic as Expr<BvType>))
            Btor2BinaryOperator.XNOR -> BvNotExpr.create(BvXorExpr.create(mutableListOf(op1ExprArithmetic as Expr<BvType>, op2ExprArithmetic as Expr<BvType>)))
            Btor2BinaryOperator.XOR -> BvXorExpr.create(mutableListOf(op1ExprArithmetic as Expr<BvType>, op2ExprArithmetic as Expr<BvType>))
            ...
            Btor2BinaryOperator.SLL -> BvShiftLeftExpr.create(op1ExprArithmetic as Expr<BvType>, op2ExprArithmetic as Expr<BvType>)
            Btor2BinaryOperator.SRA -> BvArithShiftRightExpr.of(op1ExprArithmetic as Expr<BvType>, op2ExprArithmetic as Expr<BvType>)
            Btor2BinaryOperator.SRL -> BvLogicShiftRightExpr.create(op1ExprArithmetic as Expr<BvType>, op2ExprArithmetic as Expr<BvType>)
