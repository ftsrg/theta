...
// Inputs and States
data class Btor2Input(
  override val nid: UInt,
  override val sort: Btor2Sort,
  override val state: Btor2State?,
  override val value: Btor2Node?,
) : Btor2Stateful(nid, sort, null, null) {
...
data class Btor2Init(
  ...
  override val state: Btor2State,
  override val value: Btor2Node,
) : Btor2Stateful(nid, sort, state, value) {
