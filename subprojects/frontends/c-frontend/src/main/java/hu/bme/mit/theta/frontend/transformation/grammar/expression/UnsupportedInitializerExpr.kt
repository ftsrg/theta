...
@Serializable
@SerialName("UnsupportedInitializer")
data object UnsupportedInitializerExpr : NullaryExpr<IntType>() {
  ...
  override fun toString(): String = "UnsupportedInitializer"

  @JvmStatic fun getInstance(): UnsupportedInitializerExpr = this
}
