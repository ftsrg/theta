...
import hu.bme.mit.theta.analysis.algorithm.symbolic.mdd.RelationalProductProvider;
...
public final class BfsTest {
	...
	public void testBfs() throws Exception {
		...
		BfsProvider bfs = new BfsProvider(variableOrder, new RelationalProductProvider(variableOrder));
