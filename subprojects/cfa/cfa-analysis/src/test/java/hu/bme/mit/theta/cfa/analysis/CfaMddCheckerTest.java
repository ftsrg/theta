...
//                {"src/test/resources/locking.cfa", true}, state space is not finite
    ...
    public void test() throws Exception {
        ...
        try {
            ...
            try (var solverPool = new SolverPool(solverFactory)) {
                final MddChecker<ExprAction> checker = MddChecker.create(monolithicExpr.getInitExpr(), VarIndexingFactory.indexing(0), new ExprAction() {
                    @Override
                ...
                }, monolithicExpr.getPropExpr(), solverPool, logger, MddChecker.IterationStrategy.GSAT);
