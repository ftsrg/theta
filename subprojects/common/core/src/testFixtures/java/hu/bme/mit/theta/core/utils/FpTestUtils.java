...
public class FpTestUtils {
    ...
    private static final BinaryMathContext BINARY16 =
            BinaryMathContext.BINARY16.withRoundingMode(FpUtils.getMathContextRoundingMode(RNE));
    private static final BinaryMathContext BINARY32 =
            BinaryMathContext.BINARY32.withRoundingMode(FpUtils.getMathContextRoundingMode(RNE));
    private static final BinaryMathContext BINARY64 =
            BinaryMathContext.BINARY64.withRoundingMode(FpUtils.getMathContextRoundingMode(RNE));
    ...
    public static Stream<?> GetOperations() {
        return Stream.concat(
                Stream.concat(
                        ...
                        Stream.concat(
                                LinuxSpecificTests().stream(), WindowsSpecificTests().stream())),
                Stream.concat(NaNOperations().stream(), InfinityOperations().stream()));
    }
        ...
        return Arrays.asList(
                new Object[][] {
                    ...
                    {FpToFpExpr.class, Fp16("12.0"), ToFp(RNE, Fp32("12.0"), 5, 11)},
                    {
                        ...
                        FromBv(
                                RNE,
                                BvUtils.bigIntegerToUnsignedBvLitExpr(BigInteger.ZERO, 16),
                                FpType(5, 11),
                                false)
                    },
                    {
                        ...
                        FromBv(
                                RNE,
                                BvUtils.bigIntegerToUnsignedBvLitExpr(BigInteger.ONE, 16),
                                FpType(5, 11),
                                false)
                    },
                    {
                    ...
                    },
                    {
                        ...
                        FromBv(
                                RNE,
                                BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.ZERO, 16),
                                FpType(5, 11),
                                true)
                    },
                    {
                        ...
                        FromBv(
                                RNE,
                                BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.ONE, 16),
                                FpType(5, 11),
                                true)
                    },
                    {
                    ...
                    },
                    {
                        ...
                        FromBv(
                                RNE,
                                BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.ZERO.negate(), 16),
                                FpType(5, 11),
                                true)
                    },
                    {
                        ...
                        FromBv(
                                RNE,
                                BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.ONE.negate(), 16),
                                FpType(5, 11),
                                true)
                    },
                    {
    ...
    private static FpLitExpr Fp16PInf() {
        return FpUtils.bigFloatToFpLitExpr(
                BigFloat.positiveInfinity(BINARY16.precision), FpType(5, 11));
    }

    private static FpLitExpr Fp16NInf() {
        return FpUtils.bigFloatToFpLitExpr(
                BigFloat.negativeInfinity(BINARY16.precision), FpType(5, 11));
    }
}
