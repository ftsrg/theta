...
public class FpTestUtils {
    ...
    private static final BinaryMathContext BINARY16 = BinaryMathContext.BINARY16.withRoundingMode(
            FpUtils.getMathContextRoundingMode(RNE));
    private static final BinaryMathContext BINARY32 = BinaryMathContext.BINARY32.withRoundingMode(
            FpUtils.getMathContextRoundingMode(RNE));
    private static final BinaryMathContext BINARY64 = BinaryMathContext.BINARY64.withRoundingMode(
            FpUtils.getMathContextRoundingMode(RNE));
    ...
    private static Collection<?> BasicOperations() {
        return Arrays.asList(new Object[][]{
                ...
                {FpToBvExpr.class, BvUtils.bigIntegerToUnsignedBvLitExpr(BigInteger.TEN, 16),
                ...
                {FpToBvExpr.class, BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.TEN, 16),
                        ToBv(RTZ, Fp16("10.9"), 16, true)},
                // {FpToBvExpr.class, BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.TEN, 4),
                //         ToBv(RTZ, Fp16("10.9"), 4, true)},
                {FpToBvExpr.class, BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.TEN.negate(), 16),
                        ToBv(RTZ, Fp16("-10.9"), 16, true)},
                // {FpToBvExpr.class, BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.TEN.negate(), 4),
                //         ToBv(RTZ, Fp16("-10.9"), 4, true)},
                ...
                {FpFromBvExpr.class, Fp16("0"),
                        FromBv(RNE, BvUtils.bigIntegerToUnsignedBvLitExpr(BigInteger.ZERO, 16),
                                FpType(5, 11), false)},
                {FpFromBvExpr.class, Fp16("1"),
                        FromBv(RNE, BvUtils.bigIntegerToUnsignedBvLitExpr(BigInteger.ONE, 16),
                                FpType(5, 11), false)},
                {FpFromBvExpr.class, Fp16("10"),
                        FromBv(RNE, BvUtils.bigIntegerToUnsignedBvLitExpr(BigInteger.TEN, 16),
                                FpType(5, 11), false)},
                {FpFromBvExpr.class, Fp16("0"),
                        FromBv(RNE, BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.ZERO, 16), FpType(5, 11),
                                true)},
                {FpFromBvExpr.class, Fp16("1"),
                        FromBv(RNE, BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.ONE, 16), FpType(5, 11),
                                true)},
                {FpFromBvExpr.class, Fp16("10"),
                        FromBv(RNE, BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.TEN, 16), FpType(5, 11),
                                true)},
                {FpFromBvExpr.class, Fp16("0"),
                        FromBv(RNE, BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.ZERO.negate(), 16),
                                FpType(5, 11), true)},
                {FpFromBvExpr.class, Fp16("-1"),
                        FromBv(RNE, BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.ONE.negate(), 16),
                                FpType(5, 11), true)},
                {FpFromBvExpr.class, Fp16("-10"),
                        FromBv(RNE, BvUtils.bigIntegerToSignedBvLitExpr(BigInteger.TEN.negate(), 16),
                                FpType(5, 11), true)},
        });
    }
    ...
    private static Collection<?> WindowsSpecificTests() {
        if (!OsHelper.getOs().equals(OsHelper.OperatingSystem.WINDOWS)) {
            return ImmutableSet.of();
        }
    ...
    private static FpLitExpr Fp16PInf() {
        return FpUtils.bigFloatToFpLitExpr(BigFloat.positiveInfinity(BINARY16.precision),
                FpType(5, 11));
    }

    private static FpLitExpr Fp16NInf() {
        return FpUtils.bigFloatToFpLitExpr(BigFloat.negativeInfinity(BINARY16.precision),
                FpType(5, 11));
    }
}
