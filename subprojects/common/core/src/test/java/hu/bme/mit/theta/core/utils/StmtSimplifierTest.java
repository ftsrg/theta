...
public final class StmtSimplifierTest {
    ...
    private static final Stmt SEQ_ASSIGN_X_1_ASSUME_EQ_X_1 =
            SequenceStmt.of(ImmutableList.of(ASSIGN_X_1, ASSUME_EQ_X_1));
    private static final Stmt SEQ_ASSIGN_X_1_ASSUME_LEQ_X_0 =
            SequenceStmt.of(ImmutableList.of(ASSIGN_X_1, ASSUME_LEQ_X_0));
    private static final Stmt SEQ_ASSIGN_X_1_ASSUME_TRUE =
            SequenceStmt.of(ImmutableList.of(ASSIGN_X_1, ASSUME_TRUE));
    private static final Stmt NONDET_SEQ_ASSIGN_X_1_ASSUME_EQ_X_1_OR_SEQ_ASSIGN_X_1_ASSUME_LEQ_X_0 =
            NonDetStmt.of(
    ...
    private static final Stmt NONDET_SEQ_ASSIGN_X_1_ASSUME_TRUE_OR_SEQ_ASSIGN_X_1_ASSUME_TRUE =
            NonDetStmt.of(ImmutableList.of(SEQ_ASSIGN_X_1_ASSUME_TRUE, SEQ_ASSIGN_X_1_ASSUME_TRUE));
    private static final Stmt
