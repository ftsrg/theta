        ...
        return Arrays.asList(
                new Object[][] {
                    ...
                    },
                    {
                        ...
                        ImmutableList.of(
                                And(
                                        Eq(Prime(VX.getRef()), Int(2)),
                                        Eq(Prime(Prime(VX.getRef())), Int(2))))
                    },

                    //                {Stmts.NonDetStmt(ImmutableList.of(Stmts.Assume(And(True(),
                    // False())))),
                    //
                    // ImmutableList.of(Or(ImmutableList.of(And(ImmutableList.of(
                    //                                And(Eq(TEMP0.getRef(), Int(0)),
                    //                                        And(ImmutableList.of(And(True(),
                    // False())))))))))},
                    //
                    //                {Stmts.NonDetStmt(ImmutableList.of(Stmts.Assign(VX, Int(2)))),
                    // ImmutableList.of(
                    //
                    // Or(ImmutableList.of(And(ImmutableList.of(And(Eq(TEMP0.getRef(), Int(0)),
                    //                                And(ImmutableList.of(Eq(Prime(VX.getRef()),
                    // Int(2))))))))))},
                    //
                    //                {Stmts.NonDetStmt(ImmutableList.of(Stmts.Assume(True()),
                    // Stmts.Assign(VX, Int(2)))),
                    //
                    // ImmutableList.of(Or(ImmutableList.of(And(ImmutableList.of(
                    //                                And(Eq(TEMP0.getRef(), Int(0)),
                    // And(ImmutableList.of(True()))),
                    //                                Eq(VX.getRef(), Prime(VX.getRef())))),
