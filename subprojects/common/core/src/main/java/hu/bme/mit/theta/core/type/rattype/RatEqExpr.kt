...
data class RatEqExpr(
    ...
    companion object {
        ...
        @JvmStatic
        fun of(leftOp: Expr<RatType>, rightOp: Expr<RatType>) = RatEqExpr(leftOp, rightOp)

        @JvmStatic
        fun create(leftOp: Expr<*>, rightOp: Expr<*>) = RatEqExpr(cast(leftOp, Rat()), cast(rightOp, Rat()))
    }
