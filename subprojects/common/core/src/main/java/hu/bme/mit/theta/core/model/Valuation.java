...
public abstract class Valuation implements Substitution {
    ...
    /**
     * Convert a valuation into an expression. For example if the valuation assigns 1 to x and 2 to
     * y, the expression is (x == 1 and y == 2).
     *
     * @return
     */
    ...
    /**
     * Checks if an other valuation is more general than the current one. This holds if the other
     * valuation has the same or less declarations, and for each declaration, the assigned value is
     * the same.
     *
     * @param that
     * @return
