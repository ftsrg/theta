...
data class BvNeqExpr(
    ...
    companion object {
        ...
        @JvmStatic
        fun of(leftOp: Expr<BvType>, rightOp: Expr<BvType>) = BvNeqExpr(leftOp, rightOp)

        @JvmStatic
        fun create(leftOp: Expr<*>, rightOp: Expr<*>) = BvNeqExpr(TypeUtils.castBv(leftOp), TypeUtils.castBv(rightOp))
    }
