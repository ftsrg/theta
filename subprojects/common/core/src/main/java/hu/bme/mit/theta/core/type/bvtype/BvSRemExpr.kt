...
data class BvSRemExpr(
    ...
    companion object {
        ...
        @JvmStatic
        fun of(leftOp: Expr<BvType>, rightOp: Expr<BvType>) = BvSRemExpr(leftOp, rightOp)
        @JvmStatic
        fun create(leftOp: Expr<*>, rightOp: Expr<*>) = BvSRemExpr(TypeUtils.castBv(leftOp), TypeUtils.castBv(rightOp))
    }
    ...
    override fun of(leftOp: Expr<BvType>, rightOp: Expr<BvType>): BvSRemExpr = Companion.of(leftOp, rightOp)
