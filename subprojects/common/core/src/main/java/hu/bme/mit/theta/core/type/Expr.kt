...
interface Expr<ExprType : Type> {
  ...
  /**
   * Checks if this expression is invalid. An expression is invalid if any of its operands are
   * invalid.
   */
  ...
  /**
   * Applies the given function to each operand of this expression and returns a new expression with
   * the results.
   *
