...
data class BvSExtExpr(
    ...
    companion object {
        ...
        @JvmStatic
        fun of(op: Expr<BvType>, extendType: BvType) = BvSExtExpr(op, extendType)

        @JvmStatic
        fun create(op: Expr<*>, extendType: BvType) = BvSExtExpr(castBv(op), extendType)
    }
