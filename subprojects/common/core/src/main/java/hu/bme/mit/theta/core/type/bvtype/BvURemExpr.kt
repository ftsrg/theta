...
data class BvURemExpr(
    ...
    companion object {
        ...
        @JvmStatic
        fun of(leftOp: Expr<BvType>, rightOp: Expr<BvType>) = BvURemExpr(leftOp, rightOp)
        @JvmStatic
        fun create(leftOp: Expr<*>, rightOp: Expr<*>) = BvURemExpr(TypeUtils.castBv(leftOp), TypeUtils.castBv(rightOp))
    }
