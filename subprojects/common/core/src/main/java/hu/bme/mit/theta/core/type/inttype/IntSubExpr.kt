...
data class IntSubExpr(
    ...
    companion object {
        ...
        @JvmStatic
        fun create(leftOp: Expr<*>, rightOp: Expr<*>) = IntSubExpr(cast(leftOp, Int()), cast(rightOp, Int()))
    }
    ...
    override fun new(leftOp: Expr<IntType>, rightOp: Expr<IntType>): IntSubExpr =
        of(leftOp, rightOp)
