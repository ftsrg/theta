...
data class RatGeqExpr(
    ...
    companion object {
        ...
        @JvmStatic
        fun of(leftOp: Expr<RatType>, rightOp: Expr<RatType>) = RatGeqExpr(leftOp, rightOp)

        @JvmStatic
        fun create(leftOp: Expr<*>, rightOp: Expr<*>) = RatGeqExpr(cast(leftOp, Rat()), cast(rightOp, Rat()))
    }
    ...
    override fun new(leftOp: Expr<RatType>, rightOp: Expr<RatType>): RatGeqExpr =
        of(leftOp, rightOp)
