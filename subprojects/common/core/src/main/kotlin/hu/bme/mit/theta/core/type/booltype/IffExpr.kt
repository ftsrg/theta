...
@Serializable
@SerialName("Iff")
data class IffExpr(override val leftOp: Expr<BoolType>, override val rightOp: Expr<BoolType>) :
  EqExpr<BoolType>() {
  ...
  companion object {
    ...
    @JvmStatic fun of(leftOp: Expr<BoolType>, rightOp: Expr<BoolType>) = IffExpr(leftOp, rightOp)

    @JvmStatic
    fun create(leftOp: Expr<*>, rightOp: Expr<*>) =
      IffExpr(cast(leftOp, Bool()), cast(rightOp, Bool()))
  }
