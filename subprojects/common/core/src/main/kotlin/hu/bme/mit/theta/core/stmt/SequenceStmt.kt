...
/**
 * Sequence statement of the form `sequence { STMT1; STMT2; ... }`. The statement executes all of
 * the given statements in sequence.
 */
@Serializable
@SerialName(SequenceStmt.STMT_LABEL)
data class SequenceStmt(val stmts: List<Stmt>) : Stmt {
