...
data class BvType(val size: Int, val signed: Boolean?) :
  Additive<BvType>,
  ...
  companion object {
    ...
    @JvmStatic fun of(size: Int): BvType = BvType(size, null)

    @JvmStatic fun of(size: Int, signed: Boolean?): BvType = BvType(size, signed)
  }
