...
data class FpGtExpr(override val leftOp: Expr<FpType>, override val rightOp: Expr<FpType>) :
  ...
  companion object {
    @JvmStatic fun of(leftOp: Expr<FpType>, rightOp: Expr<FpType>) = FpGtExpr(leftOp, rightOp)

    @JvmStatic
    fun create(leftOp: Expr<*>, rightOp: Expr<*>) = FpGtExpr(castFp(leftOp), castFp(rightOp))
  }
  ...
  override fun new(leftOp: Expr<FpType>, rightOp: Expr<FpType>): FpGtExpr = of(leftOp, rightOp)
