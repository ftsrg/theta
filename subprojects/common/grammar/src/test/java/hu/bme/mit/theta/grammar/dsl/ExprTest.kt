...
class ExprTest {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            return listOf(
                    ...
                    arrayOf(Ite<IntType>(True(), Int(1), Int(2)), "(ite true 1 2)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(Iff(True(), False()), "(iff true false)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(Imply(True(), False()), "(=> true false)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(Forall(listOf(p), True()), "(forall ((p Int)) true)", mapOf(Pair(NamedSymbol("p"), p))),
                    arrayOf(Exists(listOf(p), True()), "(exists ((p Int)) true)", mapOf(Pair(NamedSymbol("p"), p))),

                    arrayOf(Max(fpLit1, fpLit2), "(fpmax (#b1 #b1010 #b101010) (#b0 #b1010 #b101010))", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(Min(fpLit1, fpLit2), "(fpmin (#b1 #b1010 #b101010) (#b0 #b1010 #b101010))", emptyMap<Symbol, Decl<*>>()),

                    arrayOf(Or(True(), False()), "(or true false)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(Xor(True(), False()), "(xor true false)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(And(True(), False(), False()), "(and true false false)", emptyMap<Symbol, Decl<*>>()),
                    ...
                    arrayOf(BvExprs.Or(listOf(bvLit1, bvLit1)), "(bvor #b1010 #b1010)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(BvExprs.Xor(listOf(bvLit1, bvLit1)), "(bvxor #b1010 #b1010)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(BvExprs.And(listOf(bvLit1, bvLit1)), "(bvand #b1010 #b1010)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(BvExprs.ShiftLeft(bvLit1, bvLit1), "(bvshl #b1010 #b1010)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(BvExprs.ArithShiftRight(bvLit1, bvLit1), "(bvashr #b1010 #b1010)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(BvExprs.LogicShiftRight(bvLit1, bvLit1), "(bvlshr #b1010 #b1010)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(BvExprs.RotateLeft(bvLit1, bvLit1), "(bvrol #b1010 #b1010)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(BvExprs.RotateRight(bvLit1, bvLit1), "(bvror #b1010 #b1010)", emptyMap<Symbol, Decl<*>>()),
                    ...
                    arrayOf(Add(fpLit1, fpLit2), "(fpadd (#b1 #b1010 #b101010) (#b0 #b1010 #b101010))", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(Sub(fpLit1, fpLit2), "(fpsub (#b1 #b1010 #b101010) (#b0 #b1010 #b101010))", emptyMap<Symbol, Decl<*>>()),
                    ...
                    arrayOf(BvExprs.SDiv(bvLit1, bvLit2), "(bvsdiv #b1010 #b0101)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(BvExprs.SMod(bvLit1, bvLit2), "(bvsmod #b1010 #b0101)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(BvExprs.URem(bvLit1, bvLit2), "(bvurem #b1010 #b0101)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(BvExprs.SRem(bvLit1, bvLit2), "(bvsrem #b1010 #b0101)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(Mul(fpLit1, fpLit2), "(fpmul (#b1 #b1010 #b101010) (#b0 #b1010 #b101010))", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(FpExprs.Div(FpRoundingMode.RNE, fpLit1, fpLit2), "(fpdiv[rne] (#b1 #b1010 #b101010) (#b0 #b1010 #b101010))", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(FpExprs.Rem(fpLit1, fpLit2), "(fprem (#b1 #b1010 #b101010) (#b0 #b1010 #b101010))", emptyMap<Symbol, Decl<*>>()),

                    arrayOf(Concat(listOf(bvLit1, bvLit2)), "(++ #b1010 #b0101)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(ZExt(bvLit1, BvType(5)), "(bv_zero_extend #b1010 (Bv 5))", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(SExt(bvLit1, BvType(5)), "(bv_sign_extend #b1010 (Bv 5))", emptyMap<Symbol, Decl<*>>()),
                    ...
                    arrayOf(ArrayReadExpr.create<IntType, IntType>(ArrayLitExpr.of(emptyList(), Int(2), ArrayType.of(Int(), Int())), Int(5)), "(read (array (default 2)) 5)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(ArrayWriteExpr.create<IntType, IntType>(ArrayLitExpr.of<IntType, IntType>(emptyList(), Int(2), ArrayType.of(Int(), Int())), Int(5), Int(6)), "(write (array (default 2)) 5 6)", emptyMap<Symbol, Decl<*>>()),

                    arrayOf(Prime(Int(1)), "(prime 1)", emptyMap<Symbol, Decl<*>>()),
                    arrayOf(Extract(bvLit1, Int(1), Int(4)), "(extract #b1010 1 4)", emptyMap<Symbol, Decl<*>>()),
    ...
    fun testRoundTrip() {
        ...
        val env = Env()
        decls.forEach { env.define(it.key, it.value) }
        val expr = simplify(ExpressionWrapper(SimpleScope(symbolTable), memory.toString()).instantiate(env))
        Assert.assertEquals(simplify(memory), expr)
    }
