...
class TestGson {
  ...
  companion object {
    ...
    private fun getPredBuilder(gsonSuppl: () -> Gson): GsonBuilder {
      ...
      gsonBuilder.registerTypeHierarchyAdapter(
        ...
        ArgAdapter(
          gsonSuppl,
          { PartialOrd<PredState> { a, b -> true } },
          { predArgAdapterHelper() },
        ),
      )
      gsonBuilder.registerTypeHierarchyAdapter(
        Trace::class.java,
    ...
    private fun getGson(gsonBuilder: GsonBuilder, gsonSuppl: () -> Gson): Gson {
      ...
      gsonBuilder.registerTypeHierarchyAdapter(
        hu.bme.mit.theta.core.type.Type::class.java,
      ...
      gsonBuilder.registerTypeHierarchyAdapter(
        Triple::class.java,
        TripleAdapter<Any, Any, Any>(gsonSuppl),
      )
      gsonBuilder.registerTypeHierarchyAdapter(
        Optional::class.java,
        OptionalAdapter<Any>(gsonSuppl),
      )

      gsonBuilder.registerTypeAdapter(
        SimpleStmtAction::class.java,
        SimpleStmtActionAdapter(gsonSuppl),
      )
  ...
  fun testExplArgAdapter() {
    ...
    val otherNode =
      arg.createSuccNode(initNode, SimpleStmtAction(SkipStmt.getInstance()), ExplState.top(), false)
