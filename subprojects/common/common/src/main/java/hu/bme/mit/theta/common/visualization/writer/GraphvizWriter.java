...
/**
 * Class for writing graphs in GraphViz format. Known limitations (due to GraphViz): - Fill color of
 * composite nodes is ignored. - Shape of composite nodes is ignored. - Peripheries of composite
 * nodes are ignored.
 */
