...
/**
 * Represents a graph for visualization purposes. It has nodes, composite nodes and directed edges.
 */
public final class Graph {
    ...
    /**
     * Set a node as a child of another node. Both ids must already exist and the parent must be
     * composite.
     *
     * @param parentId
     * @param childId
