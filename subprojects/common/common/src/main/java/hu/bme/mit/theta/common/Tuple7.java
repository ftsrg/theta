...
public final class Tuple7<T1, T2, T3, T4, T5, T6, T7> extends Tuple {
    ...
    private Tuple7(final T1 e1, final T2 e2, final T3 e3, final T4 e4, final T5 e5, final T6 e6,
                   final T7 e7) {
        super(ImmutableList.of(e1, e2, e3, e4, e5, e6, e7));
    }

    public static <T1, T2, T3, T4, T5, T6, T7> Tuple7<T1, T2, T3, T4, T5, T6, T7> of(final T1 e1,
                                                                                     final T2 e2,
    ...
    public T5 get5() {
        @SuppressWarnings("unchecked") final T5 result = (T5) elem(4);
        return result;
    }

    public T6 get6() {
        @SuppressWarnings("unchecked") final T6 result = (T6) elem(5);
        return result;
    }

    public T7 get7() {
        @SuppressWarnings("unchecked") final T7 result = (T7) elem(6);
        return result;
    }
