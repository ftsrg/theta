...
final class Prod4TransFunc<S1 extends State, S2 extends State, S3 extends State, S4 extends State, A extends Action, P1 extends Prec, P2 extends Prec, P3 extends Prec, P4 extends Prec>
    ...
    private Prod4TransFunc(final TransFunc<S1, ? super A, P1> transFunc1,
                           final TransFunc<S2, ? super A, P2> transFunc2,
                           final TransFunc<S3, ? super A, P3> transFunc3,
                           final TransFunc<S4, ? super A, P4> transFunc4) {
    ...
    @Override
    public Collection<Prod4State<S1, S2, S3, S4>> getSuccStates(
            final Prod4State<S1, S2, S3, S4> state, final A action,
        ...
        final Collection<? extends S1> succStates1 = transFunc1.getSuccStates(state.getState1(),
                action,
                prec.getPrec1());
        final Optional<? extends S1> optBottom1 = succStates1.stream().filter(State::isBottom)
                .findAny();
        ...
        final Collection<? extends S2> succStates2 = transFunc2.getSuccStates(state.getState2(),
                action,
                prec.getPrec2());
        final Optional<? extends S2> optBottom2 = succStates2.stream().filter(State::isBottom)
                .findAny();
        ...
        final Collection<? extends S3> succStates3 = transFunc3.getSuccStates(state.getState3(),
                action,
                prec.getPrec3());
        final Optional<? extends S3> optBottom3 = succStates3.stream().filter(State::isBottom)
                .findAny();
        ...
        final Collection<? extends S4> succStates4 = transFunc4.getSuccStates(state.getState4(),
                action,
                prec.getPrec4());
        final Optional<? extends S4> optBottom4 = succStates4.stream().filter(State::isBottom)
                .findAny();
