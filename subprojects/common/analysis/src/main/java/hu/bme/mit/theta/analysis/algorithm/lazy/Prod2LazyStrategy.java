...
public final class Prod2LazyStrategy<
                SConcr1 extends State,
                SConcr2 extends State,
                SAbstr1 extends State,
                SAbstr2 extends State,
                S extends State,
                A extends Action>
        implements LazyStrategy<Prod2State<SConcr1, SConcr2>, Prod2State<SAbstr1, SAbstr2>, S, A> {
    ...
    private final InitAbstractor<Prod2State<SConcr1, SConcr2>, Prod2State<SAbstr1, SAbstr2>>
            initAbstractor;
    private final PartialOrd<Prod2State<SAbstr1, SAbstr2>> partialOrd;

    public Prod2LazyStrategy(
            final Lens<S, Prod2State<SConcr1, SConcr2>> lens,
    ...
    @Override
    public InitAbstractor<Prod2State<SConcr1, SConcr2>, Prod2State<SAbstr1, SAbstr2>>
            getInitAbstractor() {
    ...
    public boolean inconsistentState(final Prod2State<SConcr1, SConcr2> state) {
        return state.isBottom()
                || strategy1.inconsistentState(state.getState1())
                || strategy2.inconsistentState(state.getState2());
    }
    ...
    public void disable(
        ...
        if (state.isBottom1()
                || (!state.isBottom2() && strategy1.inconsistentState(state.getState1()))) {
            stats.setState1();
