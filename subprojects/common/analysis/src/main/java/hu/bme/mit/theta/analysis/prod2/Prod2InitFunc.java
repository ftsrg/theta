...
public final class Prod2InitFunc<
                S1 extends State, S2 extends State, P1 extends Prec, P2 extends Prec>
    ...
    private Prod2InitFunc(
            final InitFunc<S1, P1> initFunc1,
            final InitFunc<S2, P2> initFunc2,
    ...
    public static <S1 extends State, S2 extends State, P1 extends Prec, P2 extends Prec>
            Prod2InitFunc<S1, S2, P1, P2> create(
    ...
    public Collection<Prod2State<S1, S2>> getInitStates(final Prod2Prec<P1, P2> prec) {
        ...
        final Optional<? extends S1> optBottom1 =
                initStates1.stream().filter(State::isBottom).findAny();
        ...
        final Optional<? extends S2> optBottom2 =
                initStates2.stream().filter(State::isBottom).findAny();
        ...
        final Collection<Prod2State<S1, S2>> initStates =
                Prod2State.cartesian(initStates1, initStates2);
