...
public final class StmtMultiBuilderPair<LState extends ExprState, LBlank extends ExprState, LAction extends StmtAction, DataState extends ExprState, LPrec extends Prec, LBlankPrec extends Prec, RState extends ExprState, RBlank extends ExprState, RAction extends StmtAction, RPrec extends Prec, RBlankPrec extends Prec> {
    ...
    private final MultiAnalysisSide<RState, DataState, RBlank, RAction, RPrec, RBlankPrec> rightSide;
    private final LTS<? super RState, RAction> rightLts;

    StmtMultiBuilderPair(MultiAnalysisSide<LState, DataState, LBlank, LAction, LPrec, LBlankPrec> leftSide, LTS<? super LState, LAction> leftLts, MultiAnalysisSide<RState, DataState, RBlank, RAction, RPrec, RBlankPrec> rightSide, LTS<? super RState, RAction> rightLts) {
