...
public final class StmtMultiAnalysis<LState extends ExprState, RState extends ExprState, DataState extends ExprState, LBlank extends ExprState, RBlank extends ExprState,
        ...
        extends MultiAnalysis<LState, RState, DataState, LBlank, RBlank, LAction, RAction, LPrec, RPrec, DataPrec, LBlankPrec, RBlankPrec, ExprMultiState<LBlank, RBlank, DataState>, ExprMultiState<LBlank, RBlank, UnitState>, StmtMultiAction<LAction, RAction>> {

    private StmtMultiAnalysis(Function<ExprMultiState<LBlank, RBlank, DataState>, MultiSide> defineNextSide, MultiAnalysisSide<LState, DataState, LBlank, LAction, LPrec, LBlankPrec> leftSide, MultiAnalysisSide<RState, DataState, RBlank, RAction, RPrec, RBlankPrec> rightSide, InitFunc<DataState, DataPrec> dataInitFunc) {
    ...
    of(MultiAnalysisSide<LState, DataState, LBlank, LAction, LPrec, LBlankPrec> leftSide, MultiAnalysisSide<RState, DataState, RBlank, RAction, RPrec, RBlankPrec> rightSide,
    ...
    @Override
    public ExprMultiState<LBlank, RBlank, DataState> createState(LBlank leftState, RBlank rightState, DataState dataState, MultiSide sourceSide) {
        return ExprMultiState.create(leftState, rightState, dataState, sourceSide, true);
    }

    @Override
    public ExprMultiState<LBlank, RBlank, UnitState> createControlState(LBlank leftState, RBlank rightState, MultiSide sourceSide) {
        return ExprMultiState.create(leftState, rightState, UnitState.getInstance(), sourceSide, true);
    }
