...
public final class IndexedExprTransFunc
        implements TransFunc<IndexedExprState, ExprAction, UnitPrec> {

    private static final IndexedExprTransFunc INSTANCE = new IndexedExprTransFunc();
    ...
    @Override
    public Collection<? extends IndexedExprState> getSuccStates(
        ...
        final Expr<BoolType> succExpr =
                And(state.toExpr(), PathUtils.unfold(action.toExpr(), currentIndexing));
