...
final class Prod2TransFunc<S1 extends State, S2 extends State, A extends Action, P1 extends Prec, P2 extends Prec>
    ...
    public static <S1 extends State, S2 extends State, A extends Action, P1 extends Prec, P2 extends Prec> Prod2TransFunc<S1, S2, A, P1, P2> create(
            ...
            final TransFunc<S2, ? super A, P2> transFunc2) {
        return create(transFunc1, transFunc2, DefaultPreStrengtheningOperator.create(),
                (states, prec) -> states);
    }
    ...
    public static <S1 extends State, S2 extends State, A extends Action, P1 extends Prec, P2 extends Prec> Prod2TransFunc<S1, S2, A, P1, P2> create(
        ...
        return new Prod2TransFunc<>(transFunc1, transFunc2, preStrengtheningOperator,
                strenghteningOperator);
    }

    @Override
    public Collection<Prod2State<S1, S2>> getSuccStates(final Prod2State<S1, S2> state,
                                                        final A action,
        ...
        final Collection<? extends S1> succStates1 = transFunc1.getSuccStates(
        ...
        final Collection<? extends S2> succStates2 = transFunc2.getSuccStates(
        ...
        final Collection<Prod2State<S1, S2>> succStates = Prod2State.cartesian(succStates1,
                succStates2);
