 ...
 */
public final class JoiningPrecRefiner<
                S extends State, A extends Action, P extends Prec, R extends Refutation>
    ...
    public static <S extends State, A extends Action, P extends Prec, R extends Refutation>
            JoiningPrecRefiner<S, A, P, R> create(final RefutationToPrec<P, R> refToPrec) {
