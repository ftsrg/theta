...
open class MemoryEvent(
  protected val type: MemoryEventType,
  ...
  abstract class MemoryIO(
    id: Int,
    private val `var`: VarDecl<*>,
    private val localVar: VarDecl<*>,
  ...
  class Write(
    ...
    `var`: VarDecl<*>,
    localVar: VarDecl<*>,
    private val dependencies: Set<VarDecl<*>>,
    tag: String,
