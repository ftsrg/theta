...
public class LazyExprInvTransFunc<A extends Action>
        implements InvTransFunc<BasicExprState, A, UnitPrec> {
    ...
    @Override
    public Collection<? extends BasicExprState> getPreStates(
            BasicExprState state, A action, UnitPrec prec) {
