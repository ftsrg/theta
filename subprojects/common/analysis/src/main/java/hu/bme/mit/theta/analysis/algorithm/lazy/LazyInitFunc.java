...
public final class LazyInitFunc<SConcr extends State, SAbstr extends ExprState, P extends Prec>
        implements InitFunc<LazyState<SConcr, SAbstr>, P> {

    private final InitFunc<SConcr, P> concrInitFunc;
    private final InitAbstractor<SConcr, SAbstr> initAbstractor;

    private LazyInitFunc(
    ...
    public static <SConcr extends State, SAbstr extends ExprState, P extends Prec>
            LazyInitFunc<SConcr, SAbstr, P> create(
                    final InitFunc<SConcr, P> concrInitFunc,
                    final InitAbstractor<SConcr, SAbstr> initAbstractor) {
    ...
    public Collection<? extends LazyState<SConcr, SAbstr>> getInitStates(P prec) {
        final Collection<SConcr> concrInitStates =
                new ArrayList<>(concrInitFunc.getInitStates(prec));
