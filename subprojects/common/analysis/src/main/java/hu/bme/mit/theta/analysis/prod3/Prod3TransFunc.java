...
final class Prod3TransFunc<
    ...
    public static <
                    ...
                    P2 extends Prec,
                    P3 extends Prec>
            Prod3TransFunc<S1, S2, S3, A, P1, P2, P3> create(
                    final TransFunc<S1, ? super A, P1> transFunc1,
                    final TransFunc<S2, ? super A, P2> transFunc2,
                    final TransFunc<S3, ? super A, P3> transFunc3) {
    ...
    @Override
    public Collection<Prod3State<S1, S2, S3>> getSuccStates(
            final Prod3State<S1, S2, S3> state, final A action, final Prod3Prec<P1, P2, P3> prec) {
        checkNotNull(state);
        checkNotNull(action);
        checkNotNull(prec);
