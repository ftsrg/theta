...
public interface AlgorithmStrategy<SConcr extends State, SAbstr extends State, S extends State, A extends Action> {
    ...
    void block(final ArgNode<S, A> node, final A action, final S succState, final Collection<ArgNode<S, A>> uncoveredNodes);
}
