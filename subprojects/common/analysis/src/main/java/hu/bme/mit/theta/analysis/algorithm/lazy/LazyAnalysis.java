...
public final class LazyAnalysis<
                SConcr extends State, SAbstr extends ExprState, A extends Action, P extends Prec>
        implements Analysis<LazyState<SConcr, SAbstr>, A, P> {
    ...
    private LazyAnalysis(
            final PartialOrd<SAbstr> abstrOrd,
    ...
    public static <SConcr extends State, SAbstr extends ExprState, A extends Action, P extends Prec>
            LazyAnalysis<SConcr, SAbstr, A, P> create(
                    final PartialOrd<SAbstr> abstrPartialOrd,
                    final InitFunc<SConcr, P> concrInitFunc,
                    final TransFunc<SConcr, A, P> concrTransFunc,
                    final InitAbstractor<SConcr, SAbstr> initAbstractor) {
