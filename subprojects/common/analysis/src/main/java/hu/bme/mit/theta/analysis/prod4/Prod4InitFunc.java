...
final class Prod4InitFunc<
    ...
    public static <
                    ...
                    P3 extends Prec,
                    P4 extends Prec>
            Prod4InitFunc<S1, S2, S3, S4, P1, P2, P3, P4> create(
                    final InitFunc<S1, P1> initFunc1,
                    final InitFunc<S2, P2> initFunc2,
                    final InitFunc<S3, P3> initFunc3,
                    final InitFunc<S4, P4> initFunc4) {
    ...
    @Override
    public Collection<Prod4State<S1, S2, S3, S4>> getInitStates(
        ...
        final Optional<? extends S3> optBottom3 =
                initStates3.stream().filter(State::isBottom).findAny();
        ...
        final Optional<? extends S4> optBottom4 =
                initStates4.stream().filter(State::isBottom).findAny();
