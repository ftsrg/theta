...
final class Prod4InitFunc<S1 extends State, S2 extends State, S3 extends State, S4 extends State, P1 extends Prec, P2 extends Prec, P3 extends Prec, P4 extends Prec>
    ...
    public Collection<Prod4State<S1, S2, S3, S4>> getInitStates(
        ...
        final Optional<? extends S1> optBottom1 = initStates1.stream().filter(State::isBottom)
                .findAny();
        ...
        final Optional<? extends S2> optBottom2 = initStates2.stream().filter(State::isBottom)
                .findAny();
        ...
        final Optional<? extends S3> optBottom3 = initStates3.stream().filter(State::isBottom)
                .findAny();
        ...
        final Optional<? extends S4> optBottom4 = initStates4.stream().filter(State::isBottom)
                .findAny();
