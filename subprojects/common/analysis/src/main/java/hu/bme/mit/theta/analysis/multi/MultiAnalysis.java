...
public abstract class MultiAnalysis<LState extends State, RState extends State, DataState extends State, LControl extends State, RControl extends State,
        LAction extends Action, RAction extends Action,
        LPrec extends Prec, RPrec extends Prec, DataPrec extends Prec, LControlPrec extends Prec, RControlPrec extends Prec,
        MState extends MultiState<LControl, RControl, DataState>, MBlankState extends MultiState<LControl, RControl, UnitState>, MAction extends MultiAction<LAction, RAction>>
        implements Analysis<MState, MAction, MultiPrec<LPrec, RPrec, DataPrec>> {

    protected final MultiAnalysisSide<LState, DataState, LControl, LAction, LPrec, LControlPrec> leftSide;
    protected final MultiAnalysisSide<RState, DataState, RControl, RAction, RPrec, RControlPrec> rightSide;
    ...
    protected MultiAnalysis(
        ...
        this.transFunc = new MultiTransFunc<>(
    ...
    public MultiAnalysisSide<LState, DataState, LControl, LAction, LPrec, LControlPrec> getLeftSide() {
        return leftSide;
    }

    public MultiAnalysisSide<RState, DataState, RControl, RAction, RPrec, RControlPrec> getRightSide() {
        return rightSide;
    }

    protected abstract MState createInitialState(LControl leftState, RControl rightState, DataState dataState);
