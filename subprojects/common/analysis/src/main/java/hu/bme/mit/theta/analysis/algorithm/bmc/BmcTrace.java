...
/**
 * Represents a mutable, alternating trace in the form of a (State, Action,
...
public final class BmcTrace<S extends ExprState, A extends StmtAction> {
	...
	private BmcTrace(final List<? extends S> states, final List<? extends A> actions, final List<Stmt> statements) {
		checkNotNull(states);
	 ...
	 */
	public static <S extends ExprState, A extends StmtAction> BmcTrace<S, A> of(final List<? extends S> states, final List<? extends A> actions) {
