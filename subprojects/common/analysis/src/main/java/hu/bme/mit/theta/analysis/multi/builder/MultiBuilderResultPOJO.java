...
public class MultiBuilderResultPOJO<
        ...
        MState extends MultiState<LBlank, RBlank, DataState>, MBlankState extends MultiState<LBlank, RBlank, UnitState>, MAction extends MultiAction<LAction, RAction>,
    ...
    public MultiAnalysisSide<MState, DataState, MBlankState, MAction, MultiPrec<LPrec, RPrec, DataPrec>, MultiPrec<LBlankPrec, RBlankPrec, UnitPrec>> getSide() {
        return side;
    }
