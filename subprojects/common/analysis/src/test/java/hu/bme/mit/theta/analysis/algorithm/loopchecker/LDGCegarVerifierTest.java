...
public class LDGCegarVerifierTest {
    ...
    private void testWithXsts() throws IOException {
        ...
        final Refiner<
                        PredPrec,
                        LDG<XstsState<PredState>, XstsAction>,
                        LDGTrace<XstsState<PredState>, XstsAction>>
                refiner =
                        new SingleLDGTraceRefiner<>(
        ...
        final CegarChecker<
                ...
                verifier =
                        CegarChecker.create(
                                ...
                                refiner,
                                logger,
                                new LdgVisualizer<>(Objects::toString, Objects::toString));
    ...
    private void testWithCfa() throws IOException {
        ...
        final Refiner<
                        CfaPrec<PredPrec>,
                        LDG<CfaState<PredState>, CfaAction>,
                        LDGTrace<CfaState<PredState>, CfaAction>>
                refiner =
                        new SingleLDGTraceRefiner<>(
                                LDGTraceCheckerStrategy.Companion.getDefault(),
                                solverFactory,
