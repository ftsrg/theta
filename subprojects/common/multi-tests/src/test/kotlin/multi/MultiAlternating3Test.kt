...
class MultiAlternating3Test {
  ...
  fun test() {
    ...
    val doubleProduct =
      StmtMultiBuilder(xstsExplBuilder1.multiSide, xstsExplBuilder1.lts)
        .addRightSide(xstsExplBuilder2.multiSide, xstsExplBuilder2.lts)
        .build(NextSideFunctions.Alternating(), dataAnalysis.initFunc)
    val tripeProduct =
      StmtMultiBuilder(xstsExplBuilder3.multiSide, xstsExplBuilder3.lts)
    ...
    val multiConfigBuilder =
      StmtMultiConfigBuilder.ItpStmtMultiConfigBuilder(
        ...
        ItpRefToExplPrec(),
        RefToMultiPrec(ItpRefToExplPrec(), ItpRefToExplPrec(), ItpRefToExplPrec()),
        ItpRefToExplPrec(),
        dataInitPrec,
