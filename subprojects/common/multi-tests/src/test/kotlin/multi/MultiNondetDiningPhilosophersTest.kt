...
class MultiNondetDiningPhilosophersTest {
  ...
  fun test() {
    ...
    val product1 =
      StmtMultiBuilder(cfa1ExplBuilder.multiSide, cfa1ExplBuilder.lts)
    ...
    val product2 =
      StmtMultiBuilder(cfa3ExplBuilder.multiSide, cfa3ExplBuilder.lts)
        .addRightSide(cfa4ExplBuilder.multiSide, cfa4ExplBuilder.lts)
        .build(NextSideFunctions.Nondet(), ExplInitFunc.create(solver, initExpr))
    val totalProduct =
      StmtMultiBuilder(product1.side, product1.lts)
