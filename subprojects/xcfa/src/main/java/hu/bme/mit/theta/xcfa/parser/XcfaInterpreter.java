...
final class XcfaInterpreter {

	private final Env env;
	private final CoreInterpreter interpreter;

	public XcfaInterpreter(final Env env) {
	...
	private void initEnv() {
		...
		env.define("process", xcfaCreator());
	...
	public XCFA xcfa(final SExpr sexpr) {
		return (XCFA) eval(sexpr);
	}
	...
	private Function<List<SExpr>, XCFA> xcfaCreator() {
		return sexprs -> {
			final XCFA.Builder builder = XCFA.builder();
			env.push();
	...
	private Loc createLoc(final XCFA.Builder builder, final LocContext context) {
	...
	private Edge createEdge(final XCFA.Builder builder, final EdgeContext context) {
