  ...
  companion object {
    ...
    fun chcFiles(): Stream<Arguments> {
      return Stream.of(
        ...
        //                Arguments.of("/chc/chc-LIA-Arrays_000.smt2",
        // ChcFrontend.ChcTransformation.FORWARD), // nonlin
        ...
        //                Arguments.of("/chc/chc-LIA_000.smt2",
        // ChcFrontend.ChcTransformation.FORWARD), // nonlin
  ...
  fun testJSONParseRoundTrip(filePath: String) {
    ...
    main(
      arrayOf(
        ...
        "JSON",
        "--input",
        xcfaJson.absolutePath.toString(),
        "--backend",
        "NONE",
        "--stacktrace",
        "--debug",
