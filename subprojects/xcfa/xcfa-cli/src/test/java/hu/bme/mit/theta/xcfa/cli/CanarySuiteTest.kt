 ...
 * reported as `nonzero exit 137`. That is deliberately not special-cased: a test that swallows exit
 * 137 would also swallow a genuine memory regression, which is what this suite exists to catch.
 */
