# Submission of TOOL_NAME to CHC-COMP
...
The tool is used with the following parameters on CHC-COMP:
...
The _Theta_ tool is licensed under [Apache-2.0](LICENSE.md) and the licenses of libraries are summarized in [LIB_LICENSES](LIB_LICENSES.md).
