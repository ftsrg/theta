...
class UtilsTest {
    ...
    companion object {
        ...
        fun getLabels(): List<Arguments> = listOf(
            ...
            Arguments.of(NondetLabel(setOf(NopLabel(EmptyMetaData)), EmptyMetaData), NondetLabel(setOf(NopLabel(EmptyMetaData)), EmptyMetaData)),
            Arguments.of(SequenceLabel(listOf(NopLabel(EmptyMetaData)), EmptyMetaData),
                SequenceLabel(listOf(NopLabel(EmptyMetaData)), EmptyMetaData)),
