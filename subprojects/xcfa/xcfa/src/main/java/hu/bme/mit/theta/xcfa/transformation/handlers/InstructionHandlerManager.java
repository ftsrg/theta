...
package hu.bme.mit.theta.xcfa.transformation.handlers;

import hu.bme.mit.theta.xcfa.transformation.ArithmeticType;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.AggregateInstructionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.ArrayIntrinsicsHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.BinaryInstructionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.BitvectorInstructionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.BitwiseInstructionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.BuiltinFunctionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.ConversionInstructionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.MemoryInstructionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.OtherInstructionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.TerminatorInstructionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.UnaryInstructionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.VectorInstructionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.concrete.checks.PointerArithmeticCheck;
