...
public class XcfaStmtUtils {
	 ...
	 * @return 			Optional.empty() when no modification was necessary, the new Stmt otherwise
	 */
	public static <T extends Type> Optional<Stmt> replaceStmt(final Stmt stmt, final Function<Expr<T>, Optional<Expr<T>>> mapper) {
		return stmt.accept(new StmtExpressionMappingVisitor<>(), mapper);
	}
	 ...
	 */
	public static <P extends Type> List<Stmt> replaceVarWithArrayItem(final Stmt stmt, final Map<Decl<?>, Tuple2<VarDecl<ArrayType<P, ?>>, LitExpr<P>>> lookup) {
