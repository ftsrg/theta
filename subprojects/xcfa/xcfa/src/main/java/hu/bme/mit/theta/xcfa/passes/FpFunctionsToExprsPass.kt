...
class FpFunctionsToExprsPass : ProcedurePass {
    ...
    companion object {
        ...
        private fun addHandler(names: Array<String>, handler: BiFunction<XcfaProcedureBuilder, InvokeLabel, XcfaLabel>) {
            for (name in names) {
        ...
        init {
            addHandler(arrayOf("fabs", "fabsf", "fabsl")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleFabs(builder, callStmt) }
            addHandler(arrayOf("floor", "floorf", "floorl")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleFloor(builder, callStmt) }
            addHandler(arrayOf("fmax", "fmaxf", "fmaxl")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleFmax(builder, callStmt) }
            addHandler(arrayOf("fmin", "fminf", "fminl")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleFmin(builder, callStmt) }
            addHandler(arrayOf("fmod", "fmodf", "fmodl")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleFmod(builder, callStmt) }
            addHandler(arrayOf("sqrt", "sqrtf", "sqrtl")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleSqrt(builder, callStmt) }
            addHandler(arrayOf("round", "roundf", "roundl")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleRound(builder, callStmt) }
            addHandler(arrayOf("isnan")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleIsnan(builder, callStmt) }
            addHandler(arrayOf("trunc")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleTrunc(builder, callStmt) }
            addHandler(arrayOf("ceil")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleCeil(builder, callStmt) }
            addHandler(arrayOf("isnormal")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleIsnormal(builder, callStmt) }
            addHandler(arrayOf("isinf", "__isinf", "__isinff", "__isinfl")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleIsinf(builder, callStmt) }
            addHandler(arrayOf("isfinite")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleIsfinite(builder, callStmt) }
            addHandler(arrayOf("__fpclassify", "__fpclassifyf", "__fpclassifyl")) { builder: XcfaProcedureBuilder, callStmt: InvokeLabel -> handleFpclassify(builder, callStmt) }
        }
        ...
        private fun handleFpclassify(builder: XcfaProcedureBuilder, callStmt: InvokeLabel): XcfaLabel {
            throw UnsupportedOperationException()
        }
