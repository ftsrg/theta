 ...
 * model, losing the handle) and hence before the ordinary [UnrollPass], so the create/join loops
 ...
 * element -- and only such a procedure, so nothing else is touched -- it runs [UnrollPass] early,
