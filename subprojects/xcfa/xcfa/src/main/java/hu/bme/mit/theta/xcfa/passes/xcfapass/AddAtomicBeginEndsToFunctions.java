...
public class AddAtomicBeginEndsToFunctions extends XcfaPass {

	@Override
	public XCFA.Builder run(XCFA.Builder xcfaBuilder) {
		for (XcfaProcess.Builder process : xcfaBuilder.getProcesses()) {
			for (XcfaProcedure.Builder builder : process.getProcedures()) {
