...
package hu.bme.mit.theta.xcfa.transformation.handlers.concrete;
...
import hu.bme.mit.theta.xcfa.transformation.handlers.BaseInstructionHandler;
import hu.bme.mit.theta.xcfa.transformation.handlers.Instruction;
import hu.bme.mit.theta.xcfa.transformation.handlers.arguments.Argument;
import hu.bme.mit.theta.xcfa.transformation.handlers.arguments.RegArgument;
import hu.bme.mit.theta.xcfa.transformation.handlers.arguments.StringArgument;
...
import hu.bme.mit.theta.xcfa.transformation.handlers.utils.PlaceholderAssignmentStmt;
...
import static hu.bme.mit.theta.xcfa.transformation.Utils.foldExpression;
import static hu.bme.mit.theta.xcfa.transformation.Utils.getOrCreateVar;
...
public class OtherInstructionHandler extends BaseInstructionHandler {
    ...
    private void call(Instruction instruction, GlobalState globalState, FunctionState functionState, BlockState blockState) {
        ...
        if (globalState.getProcedures().stream().anyMatch(objects -> objects.get1().equals(functionName.getName()))) {
            ...
            if(callVar != null) exprs.add(callVar.getRef());
