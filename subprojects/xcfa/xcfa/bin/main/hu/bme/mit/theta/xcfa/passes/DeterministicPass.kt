...
/**
 * This pass converts all edges to a deterministic normal form, i.e., no NonDetLabels can be found
 * on the edges. Requires the ProcedureBuilder to be `normal` (@see NormalizePass) Sets the
