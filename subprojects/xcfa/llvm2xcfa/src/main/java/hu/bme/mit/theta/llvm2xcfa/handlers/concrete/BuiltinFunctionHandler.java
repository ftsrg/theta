...
public class BuiltinFunctionHandler extends BaseInstructionHandler {
    private static final Collection<String> SVCOMP_ERROR_FUNCTIONS =
            List.of("__assert_fail", "__VERIFIER_error", "abort", "reach_error");
    private static final Collection<String> SVCOMP_NEWTHREAD_FUNCTIONS =
            List.of("theta_pthread_create");
    private static final Collection<String> SVCOMP_JOINTHREAD_FUNCTIONS = List.of("pthread_join");
    private static final Collection<String> SVCOMP_ATOMIC_BEGIN =
            List.of("__VERIFIER_atomic_begin");
    private static final Collection<String> SVCOMP_ATOMIC_END = List.of("__VERIFIER_atomic_end");
    private static final Collection<String> ATOMIC_READ = List.of("atomic_load_explicit");
    private static final Collection<String> ATOMIC_WRITE = List.of("atomic_store_explicit");
