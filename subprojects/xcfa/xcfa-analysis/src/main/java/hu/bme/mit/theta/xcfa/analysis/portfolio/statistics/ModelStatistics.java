...
/**
 * Class that extracts statistical information out of the input C program and the (X)CFA and is
 * capable of outputting it in a csv (one line, that can be merged with other, similar csvs) and txt
...
public class ModelStatistics {
    ...
    /**
     * Write info on the input task and the model into a one-liner csv (so it can be merged into a
     * dataframe with other such files)
     */
