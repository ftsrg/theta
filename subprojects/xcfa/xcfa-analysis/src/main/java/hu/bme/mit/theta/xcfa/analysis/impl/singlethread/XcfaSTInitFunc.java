...
public class XcfaSTInitFunc<S extends ExprState, P extends Prec> implements InitFunc<XcfaSTState<S>, XcfaSTPrec<P>> {
	...
	@Override
	public Collection<XcfaSTState<S>> getInitStates(final XcfaSTPrec<P> prec) {
