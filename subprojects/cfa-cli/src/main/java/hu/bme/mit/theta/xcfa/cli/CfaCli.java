...
import hu.bme.mit.theta.xcfa.CFA;
import hu.bme.mit.theta.xcfa.analysis.CfaAction;
import hu.bme.mit.theta.xcfa.analysis.CfaState;
import hu.bme.mit.theta.xcfa.analysis.CfaTraceConcretizer;
import hu.bme.mit.theta.xcfa.analysis.config.CfaConfig;
import hu.bme.mit.theta.xcfa.analysis.config.CfaConfigBuilder;
import hu.bme.mit.theta.xcfa.analysis.config.CfaConfigBuilder.Domain;
import hu.bme.mit.theta.xcfa.analysis.config.CfaConfigBuilder.Encoding;
import hu.bme.mit.theta.xcfa.analysis.config.CfaConfigBuilder.InitPrec;
import hu.bme.mit.theta.xcfa.analysis.config.CfaConfigBuilder.PrecGranularity;
import hu.bme.mit.theta.xcfa.analysis.config.CfaConfigBuilder.PredSplit;
import hu.bme.mit.theta.xcfa.analysis.config.CfaConfigBuilder.Refinement;
import hu.bme.mit.theta.xcfa.analysis.config.CfaConfigBuilder.Search;
import hu.bme.mit.theta.xcfa.analysis.utils.CfaVisualizer;
import hu.bme.mit.theta.xcfa.dsl.CfaDslManager;
