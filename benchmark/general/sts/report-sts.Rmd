...
params:
  csv_path: "log_20170412_174804.csv"
  timeout_ms: 600000
output:
  html_document:
    code_folding: hide
...
```{r}
pairwise_plot(d, "TimeMs", "Refinement", "BW_CRAIG_ITP", "FW_CRAIG_ITP",
              c("Type", "Model", "Domain", "InitPrec", "Search", "PredSplit"), "Type",
              log_scale = T, bin_width = .25, na_fill = params$timeout_ms, pt_position = "jitter")
pairwise_plot(d, "TimeMs", "Refinement", "BW_CRAIG_ITP", "SEQ_ITP",
              c("Type", "Model", "Domain", "InitPrec", "Search", "PredSplit"), "Type",
              log_scale = T, bin_width = .25, na_fill = params$timeout_ms, pt_position = "jitter")
pairwise_plot(d, "TimeMs", "Refinement", "FW_CRAIG_ITP", "SEQ_ITP",
              c("Type", "Model", "Domain", "InitPrec", "Search", "PredSplit"), "Type",
              log_scale = T, bin_width = .25, na_fill = params$timeout_ms, pt_position = "jitter")
```
