...
int main()
{
    ...
    // unlock phase
        ...
        if (p6 != 0) {
            if (lk6 != 1) assert(0); // assertion failure
            lk6 = 0;
        } else {}

        if (p7 != 0) {
            if (lk7 != 1) assert(0); // assertion failure
            lk7 = 0;
        } else {}

        if (p8 != 0) {
            if (lk8 != 1) assert(0); // assertion failure
            lk8 = 0;
        } else {}

        if (p9 != 0) {
            if (lk9 != 1) assert(0); // assertion failure
            lk9 = 0;
        } else {}

        if (p10 != 0) {
            if (lk10 != 1) assert(0); // assertion failure
            lk10 = 0;
        } else {}

        if (p11 != 0) {
            if (lk11 != 1) assert(0); // assertion failure
            lk11 = 0;
        } else {}

        if (p12 != 0) {
            if (lk12 != 1) assert(0); // assertion failure
            lk12 = 0;
        } else {}

        if (p13 != 0) {
            if (lk13 != 1) assert(0); // assertion failure
            lk13 = 0;
        } else {}

        if (p14 != 0) {
            if (lk14 != 1) assert(0); // assertion failure
            lk14 = 0;
        } else { assert(0); }

        if (p15 != 0) {
            if (lk15 != 1) assert(0); // assertion failure
            lk15 = 0;
        } else {}
