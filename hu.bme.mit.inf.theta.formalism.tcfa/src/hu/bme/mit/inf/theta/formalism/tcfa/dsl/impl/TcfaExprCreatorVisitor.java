...
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslBaseVisitor;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.AccessContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.AccessorExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.AdditiveExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.AndExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.ArrayAccessContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.EqualityExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.ExistsExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.ExprListContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.FalseExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.ForallExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.FuncAccessContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.FuncLitExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.IdExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.IffExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.ImplyExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.IntLitExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.IteExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.MultiplicativeExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.NegExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.NotExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.OrExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.ParenExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.RatLitExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.RelationExprContext;
import hu.bme.mit.inf.theta.formalism.tcfa.dsl.gen.TcfaDslParser.TrueExprContext;
...
final class TcfaExprCreatorVisitor extends TcfaDslBaseVisitor<Expr<?>> {
	...
	public Expr<?> visitEqualityExpr(final EqualityExprContext ctx) {
		if (ctx.rightOp != null) {
			...
			case TcfaDslParser.EQ:
				return Eq(leftOp, rightOp);
			case TcfaDslParser.NEQ:
	...
	public Expr<?> visitRelationExpr(final RelationExprContext ctx) {
		if (ctx.rightOp != null) {
			...
			switch (ctx.oper.getType()) {
			case TcfaDslParser.LT:
				return Lt(leftOp, rightOp);
			case TcfaDslParser.LEQ:
				return Leq(leftOp, rightOp);
			case TcfaDslParser.GT:
				return Gt(leftOp, rightOp);
			case TcfaDslParser.GEQ:
	...
	private Expr<?> createAdditiveSubExpr(final Expr<?> leftOp, final Expr<?> rightOp, final Token oper) {
		...
		case TcfaDslParser.PLUS:
			return createAddExpr(leftOp, rightOp);

		case TcfaDslParser.MINUS:
