...
public class ExpressionAstFactory {
	...
	public static UnaryExpressionAst PrefixIncr(ExpressionAst operand) {
		return new UnaryExpressionAst(operand, UnaryExpressionAst.Operator.OP_PREFIX_INCR);
	}

	public static UnaryExpressionAst PostfixIncr(ExpressionAst operand) {
		return new UnaryExpressionAst(operand, UnaryExpressionAst.Operator.OP_POSTFIX_INCR);
	}

	public static UnaryExpressionAst PrefixDecr(ExpressionAst operand) {
		return new UnaryExpressionAst(operand, UnaryExpressionAst.Operator.OP_PREFIX_DECR);
	}

	public static UnaryExpressionAst PostfixDecr(ExpressionAst operand) {
		return new UnaryExpressionAst(operand, UnaryExpressionAst.Operator.OP_POSTFIX_DECR);
	}
