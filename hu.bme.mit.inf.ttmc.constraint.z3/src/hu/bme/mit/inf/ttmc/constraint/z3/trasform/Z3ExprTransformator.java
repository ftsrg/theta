...
class Z3ExprTransformator {

	private final Z3TransformationManager transformator;
	private final Context context;

	private final Z3ExprTransformatorVisitor visitor;

	private final Map<Expr<?>, com.microsoft.z3.Expr> exprToTerm;

	Z3ExprTransformator(final Z3TransformationManager transformator, final Context context) {
		this.context = context;
		this.transformator = transformator;
		visitor = new Z3ExprTransformatorVisitor();
	...
	private class Z3ExprTransformatorVisitor implements ExprVisitor<Void, com.microsoft.z3.Expr> {

		private final com.microsoft.z3.BoolExpr falseTerm;
		private final com.microsoft.z3.BoolExpr trueTerm;

		private Z3ExprTransformatorVisitor() {
		...
		public com.microsoft.z3.Expr visit(final ImplyExpr expr, final Void param) {
			final com.microsoft.z3.BoolExpr leftOpTerm = (com.microsoft.z3.BoolExpr) expr.getLeftOp().accept(this,
					param);
			final com.microsoft.z3.BoolExpr rightOpTerm = (com.microsoft.z3.BoolExpr) expr.getRightOp().accept(this,
					param);
		...
		public com.microsoft.z3.Expr visit(final GeqExpr expr, final Void param) {
			final com.microsoft.z3.ArithExpr leftOpTerm = (com.microsoft.z3.ArithExpr) expr.getLeftOp().accept(this,
					param);
		...
		public com.microsoft.z3.Expr visit(final IntDivExpr expr, final Void param) {
			...
			final com.microsoft.z3.IntExpr rightOpTerm = (com.microsoft.z3.IntExpr) expr.getRightOp().accept(this,
					param);
		...
		public <IndexType extends Type, ElemType extends Type> com.microsoft.z3.Expr visit(
			...
			final com.microsoft.z3.ArrayExpr arrayTerm = (com.microsoft.z3.ArrayExpr) expr.getArray().accept(this,
					param);
