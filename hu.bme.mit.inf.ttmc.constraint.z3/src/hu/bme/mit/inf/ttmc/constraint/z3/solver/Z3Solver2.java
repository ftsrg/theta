...
public class Z3Solver2 implements Solver {
	...
	public Z3Solver2(final ConstraintManager manager, final Context context, final Z3TermWrapper termWrapper,
			final Z3TransformationManager transformator) {
		this(manager, context, context.mkSimpleSolver(), termWrapper, transformator);
	}

	public Z3Solver2(final ConstraintManager manager, final Context context, final com.microsoft.z3.Solver z3Solver,
			final Z3TermWrapper termWrapper, final Z3TransformationManager transformator) {
	...
	public void add(final Expr<? extends BoolType> assertion) {
		...
		final com.microsoft.z3.BoolExpr term = (com.microsoft.z3.BoolExpr) transformator.transform(assertion);
		z3Solver.add(term);
