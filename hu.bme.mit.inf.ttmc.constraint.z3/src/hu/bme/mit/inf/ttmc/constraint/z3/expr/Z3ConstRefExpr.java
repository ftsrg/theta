...
public final class Z3ConstRefExpr<DeclType extends Type> extends AbstractConstRefExpr<DeclType>
		implements Z3Expr<DeclType> {

	private final Context context;

	private volatile com.microsoft.z3.Expr term;

	public Z3ConstRefExpr(final ConstraintManager manager, final ConstDecl<DeclType> constDecl, final Context context) {
