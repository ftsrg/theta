...
public class Z3RemExpr extends RemExprImpl implements Z3Expr<IntType> {

	private final Context context;
	
	private volatile com.microsoft.z3.IntExpr term;

	public Z3RemExpr(final Expr<? extends IntType> leftOp, final Expr<? extends IntType> rightOp,
